<?php
	...
	$s=mysql_query("SELECT firstaccess,orgtype,id, firstname, lastname, username, traineeid, country, email FROM mdl_cifauser WHERE id='".$usercandidateid."' ORDER BY id DESC");
