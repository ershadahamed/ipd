...
$string['allowguests'] = 'This module allows guest users to enter';
$string['guest:config'] = 'Configure guest access instances';
$string['password'] = 'Password';
$string['password_help'] = 'A password allows guest access to the module to be restricted to only those who know the password. Guests will be required to supply the password each time they access the module.';
...
$string['pluginname_desc'] = 'Guest access plugin is only granting temporary access to modules, it is not actually enrolling users.';
$string['requirepassword'] = 'Require guest access password';
$string['requirepassword_desc'] = 'Require access password in new modules and prevent removing of access password from existing modules.';
...
$string['status_help'] = 'This setting determines whether a user can access the module as a guest, without being required to enrol.';
