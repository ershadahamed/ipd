...
<form method="post" name="form" onSubmit="return valaction(this);">
...
<tr valign="top"><td><input type="checkbox" name="agree" /></td><td>
I have read and understood the terms and policies pertaining to the SHAPETM Online Training Program. I hereby agree to adhere to these terms and policy. 
</td></tr>
</table><br/>
<table style="width:10%; margin:0 auto;">
<tr valign="top"><td><input type="submit" name="proceddnext" value=" Next >> "/></td></tr>
</table>
</td></tr></table>
</form>

	<script language="JavaScript" type="text/javascript">
	function valaction(form)
	{
		var VAL = true;		
