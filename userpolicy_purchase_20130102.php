...
<?php
	...
	$link=$CFG->wwwroot. '/success_purchase.php?name='.$firstname.'&middlename='.$middlename.'&lastname='.$lastname.'&dob='.$dob.'&address='.$address.'&address2='.$address2.'&title='.$title.'&email='.$email.'&phone='.$phone.'&state='.$province.'&postalcode='.$postal.'&country='.$country;?>	
...
<tr valign="top"><td><input type="button" name="proceddnext" value=" << Confirm >> " onclick="checkfield()"/></td></tr>
</table>
</td></tr></table>
</form>
