...
class user_edit_form_roles extends moodleform {
    ...
    function definition () {
        ...
        $strgeneral  = get_string('pictureofuser');
        ...
        if($USER->id == '2'){ $mform->addElement('header', 'moodle', $strgeneral); }
        ...
        //$this->add_action_buttons(false, get_string('updatemyprofile')); //ori
		//$this->add_action_buttons(false, get_string('save')); 
		//$this->add_action_buttons($cancel = true, $submitlabel=get_string('save'));
		$this->add_action_buttons2(false, get_string('save'));
