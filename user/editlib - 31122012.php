...
function useredit_shared_definition(&$mform, $editoroptions = null) {
	...
	$mform->addElement('text', 'phone2', get_string('hometel'), 'maxlength="20" size="25"');
    $mform->setType('phone2', PARAM_NOTAGS);	//home phone

	$mform->addElement('text', 'phone1', get_string('phone2'), 'maxlength="20" size="25"');
	...
	$empstatuslist = array();
	$empstatuslist['']=get_string('empstatus');
	...
	$mform->addElement('date_selector', 'yearexperience', get_string('yearinfield'));
}
