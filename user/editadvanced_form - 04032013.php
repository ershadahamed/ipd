...
class user_editadvanced_form extends moodleform {
    ...
    function definition() {
		...
		//$candidatesI=$year.''.$month.''.$a.''.$tid;  
		$candidatesI=$year.''.$a.''.$tid; 		
		//Ended by arizan abdullah 20121004////
		
		$mform->addElement('text', 'username', get_string('username'), 'value="'.strtolower($candidatesI).'" size="20"');
       ...
       // $mform->addElement('select', 'auth', get_string('chooseauthmethod','auth'), $auth_options);
        ...
        $mform->addElement('passwordunmask', 'newpassword', get_string('newpassword'), 'size="20" value="Password01$"');
		//$mform->addElement('static', '', get_string('newpassword').' <br/>(Default password)', 'Password01$');
		//$mform->addElement('hidden', 'newpassword', 'Password01$');
		...
		if($USER->id =='2'){
			$mform->addElement('header', 'user', 'User picture');
		}
