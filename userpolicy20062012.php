...
function checkfield(msg){
	pengakuan1 = 'Please check, if you agree with the policy.';
...
<p><strong>SHAPETM Online Training Program User  Policies – Please Read Before Purchasing</strong><br/>
  Portal user will  need to agree and accept the policies for the SHAPETM Online Training  Program. Please read each of these carefully before agreeing to the terms as  these policies will be strictly enforced.</p>
<ol style="list-style-type:upper-alpha">
	<li><strong>Your Subscription Begins  the First Time You Log In:</strong></li><br/>
	<ol id="myList">
		<li>All SHAPETM online  training programs are valid for 3 months from the first time login. </li>
		...
		<li>Your subscription begins from  the first time you use the Candidate ID and Password to log in. SHAPETM  recommends that you write down the date and time of your first login, so you  may keep track of your account expiration. </li>
		<li>SHAPETM will send  email reminders as your subscription is expiring. </li>
	...
	<li><strong>E-Learning Users are Not  Allowed to Share Account Access:</strong></li><br/>
		<ol id="myList">
		  <li>Under no circumstances is it  permissible for two or more people to share the access to the SHAPETM  online training program. An e-Learning access is similar to a software license,  in that the permission to use the service lies solely with one person. </li>
	...
	<li><strong>E-Learning Users are NOT  Allowed to teach using ANY of SHAPETM Online Training Program:</strong></li><br/>
		<p>You are not allowed to teach or  instruct using SHAPETM e-Learning as instructional tools for ANY  REASON without the written permission from SHAPETM. Doing this is  equivalent to sharing account access, and as stated above this is strictly  prohibited.<strong></strong></p>  
	...
	<li><strong>You are Responsible for  Verifying System Requirements:</strong></li><br/>
		...
		We encourage user to try the online  demo available at <a href="http://www.CIFAOnline.com/demo">www.CIFAOnline.com/demo</a> prior to purchasing of SHAPETM e-learning training programs to  ensure compatibility of SHAPETM e-Learning applications to your  computer system. </p>
		<p>If your system presents the graphics, audio  and video in this sample correctly, you should have no problem using any of SHAPETM  e-Learning based materials. If you are unsure whether or not your computer is  compatible with SHAPETM e-Learning applications, refer to the System  Requirements below. <br />
	...
	<li><strong>Refunds are ONLY allowed  under the following circumstances  :</strong></li><br/>
		<ol id="myList">
		<li>Double payment for the same  training program. Claim MUST be done within 7 Days of purchase. After which,  until the 30th Day, SHAPETM will deduct 10% of total  refund amount to cover the administrative charges. </li>
		<li>Cancellation of training  program MUST be done within 24 hours of purchase. This is ONLY allowed for  unused training programs only. For cancellation, the enrolment fees will be  forfeited and SHAPETM will deduct 5% of total refund amount to cover  the administrative charges. </li>
		</ol>  <br/>
	<li><strong>Processing of refund: </strong> </li><br/>
		...
		<li>Refund will be made respective  to the mode of payment used by user to purchase the online training program. SHAPETM  will not be responsible for losses or differences in the foreign exchange  rates. </li>
...
I have read and understood the terms and policies pertaining to the SHAPETM Online Training Program. I here by agree to adhere to these terms and policy. 
</td></tr>
</table><br/>
<table style="width:10%; margin:0 auto;">
<tr valign="top"><td><input type="submit" name="proceddnext" value=" Next >> " onclick="checkfield()"/></td></tr>
</table>
</td></tr></table>
</form>
<?php /*if(isset($_POST['proceddnext'])){ ?>
 <script style="text/javascript">
		  window.opener.location.href="<?php echo $CFG->wwwroot. '/portal/subscribe/subscribedetails_loggeduser.php?traineeID=CIFA-0040-0039&&trainee_name=Mohd Saiful&&lastname=Shamsuddin&&address=Jln 4/1, Sungai besi Indah&&address2=&&email=arizan_86@yahoo.com&&phone=01233440021&&city=Selangor&&province=Seri kembangan&&postal=43300&&country=MY&&cost=2&&currency=MYR&&PaypalBusinessEmail=arizanabdullah@hotmail.my&&coursename=CIFA Foundation - Ijara&&shortname=CIFA Foundation 06&&courseid=39'; ?>";
          self.close();
</script><?php
}*/
?>
