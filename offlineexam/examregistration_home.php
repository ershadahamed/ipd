...
<table style="margin: 0 auto; width:95%; padding-bottom:10px;">
	<tr valign="top">
		<td width="15%">Choose an Exam</td><td width="1%">:</td>
		<td>
		<select name="choose_exam" style="width:200px;">
			<option value=""> None </option>
			<option value="all"> All CIFA&#8482; Exams
			<?php
	...
	<tr valign="top">
		<td width="15%">Candidate Details</td><td width="1%">:</td>
		<td>
			<!--input type="text" name="traineeid" size="50" style="height:20px"/-->	
			<select name="choose_details" style="width:200px;">
			...
			<input type="text" name="traineeid" size="50" style="height:20px"/>
			<input type="submit" name="search" value="<?=get_string('search');?>" style="width:60px;" />
		</td>
		<td></td>
	</tr>		
</table><!--/fieldset-->
...
<?php 
	...
	if($rsCount>='0'){	
		...
		//echo $qdownload;
		if($qdownload=='0'){ //check if registed or not
		//count module
