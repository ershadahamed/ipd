...
<img class="table-bg-image" src="<?=$CFG->wwwroot;?>/image/statementbg_copy.jpg"/>
<table class="with-bg-image" border="0" cellspacing="0" cellpadding="10" style="width:98%;padding:0px; margin:0px;" align="center"><tr><td style="vertical-align:top;">
...
<table width="90%" border="0" cellpadding="0" cellspacing="0" style="font-weight:bolder;border-collapse:collapse;margin:1em 0;">
  <tr>
    <td align="left">
	<?php 
    if($qgrade['course']=='12'){ 
