<?php
	...
	if($_POST['checktoken'] == ""){
		if(($_GET['examid']!='')){
			...
			$sql = "Select * From mdl_cifauser a Inner Join mdl_cifauser_accesstoken b On a.id = b.userid Where a.id='".$tokenid."' AND b.courseid='".$courseid."'";
			$result=mysql_query($sql);
			if(mysql_num_rows($result)>0){
				$fileContent="Username;Firstname;Lastname;Email;Traineeid;Country;City;Courseid;Accesstoken\n";				
