...
<div id="page">
	...
	<div id="page-header" style="background-size: 100% Auto; min-height: 165px;background-image:url('<?php echo $CFG->wwwroot. '/image/logo-learning-cifa.png';?>'); background-repeat:no-repeat; background-color: #5386bd;">        
			...
			<div id="region-post-box">
			  ...
			  <div id="region-main-wrap">
                 <div id="region-main">
                        ...
                        <!-- <div class="region-content" style="width: 20%;margin: 50px auto;"> -->
