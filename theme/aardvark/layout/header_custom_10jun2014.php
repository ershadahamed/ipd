    ...
    <div class="container_2">
        <div id="main-topbar">
				<div id="main-menu" <?php if (!isloggedin()) {?> style="width:100%;" <?php } ?>>
					...
					<ul class="menu-list">
						<li class="menu-item">
								<a href="<?=$CFG->wwwroot.'/index.php'; ?>" class="menu-link"><i><img style="width:23px;" src="<?=$CFG->wwwroot;?>/theme/aardvark/pix/glyphicons.png"></i></a>
						</li>
						<!--li class="menu-item">
        ...
        <div id="main-logo-sm">
            <a href="#"><img src="<?php echo $PAGE->theme->settings->logo;?>" width="164px"/></a>
        </div><!-- #main-logo-sm -->		
            <div class="row">
