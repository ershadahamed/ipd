                                    ...
                                    <div id="region-post" class="block-region">
                                        <div class="region-content">				
                                            ...
                                            if ($PAGE->pagelayout == 'frontpage') {
                                                ...
                                                echo $a2 . '<a href="'.$CFG->wwwroot.'/enrol/users.php?id=32&page=0&perpage=400&sort=lastname&dir=ASC">' . 'Extend the course' . $a_close . $b2;
                                                echo $a2 . '<a href="'.$CFG->wwwroot.'/resit_test.php">' . 'Re-sit Test' . $a_close . $b2;
												echo $a2 . '<a href="'.$CFG->wwwroot.'/organization/orgview.php">' . 'Sales & Services' . $a_close . $b2;
