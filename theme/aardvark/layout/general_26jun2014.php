...
<div id="contentwrapper">	
	...
	<?php }else{ echo '<br/>'; } ?>
	<div id="page-content" style="min-height:350px;">
					...
					<?php if($USER->id=='2'){ 
					 ...
					 <?php	
						...
						if($PAGE->pagelayout=='mydashboard'){
							...
							$mock_link='<a href="'.$CFG->wwwroot.'/course/mock_exam.php?id='.$USER->id.'">';
							$m_close='</a>';
							...
							echo $bottomspacewhite.$a.$af_open."<b>".$moduletitle."</b>".$a_close.$b;							 	
							...
							echo $topspacewhite.$a.$af_open.$moduletitle.$a_close.$b;							 	
							if($sqlcount!='0'){ echo $bottomspacewhite.$a.$eg_open.$titleeg.$a_close.$b; }else{ echo $a.$titleeg.$b;}							
				...
				<div class="region-content">				
					<?php 
						...
						if($PAGE->pagelayout=='frontpage'){							
							...
							echo $a2.$an_open.get_string('editexamrules').$a_close.$b2;		
