    ...
    <div id="page" style="width:90%;">
        ...
        <div id="page-header">
            <div id="page-header-wrapper" class="wrapper clearfix">
                ...
                <div id="logobox">
                    <?php if ($haslogo) {
                        echo html_writer::link(new moodle_url('/'), "<img src='".$PAGE->theme->settings->logo."' alt='logo' title='CIFAOnline' />");
                    } else {
					...
					<?php if (isloggedin()) { ?>
						<?php 
							...
							if($USER->id != '2'){
								...
								if($groupuserid=='13'){
									//echo $custommenu;//http://192.168.1.237/shape/mod/feedback/view.php?id=207
									...
									echo html_writer::end_tag('li');
									echo html_writer::start_tag('li', array('style'=>'padding: 0 10px;', 'class'=>'yui3-menuitem', 'role'=>'presentation'));
									echo html_writer::link(new moodle_url('/mod/feedback/view.php', array('id'=>'207')), get_string('feedback').' &nbsp;');
									echo html_writer::end_tag('li');									
									echo html_writer::start_tag('li', array('style'=>'padding: 0 10px;', 'class'=>'yui3-menuitem', 'role'=>'presentation'));
