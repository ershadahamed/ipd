...
$string['addnewcategory'] = 'Add new program';
//$string['addnewcategory'] = 'Add new category';
//$string['addnewcourse'] = 'Add a new course';
$string['addnewcourse'] = 'Add a new';
$string['addnewcourse2'] = 'Add a new module test';
...
$string['addsubcategory'] = 'Add a sub-program';
...
$string['availability_help'] = 'This setting determines whether the module appears in the list of modules. Apart from trainers and administrators, users are not allowed to enter the module.';
...
//$string['backup'] = 'Generate exam software';
...
//$string['backupfilename'] = 'download';
...
$string['blockseditoff'] = 'Back to normal pages';
...
//$string['categories'] = 'Manage curriculum/module';
$string['categories'] = 'Programs';
//$string['category'] = 'Curriculum';
$string['category'] = 'Program';
$string['category_help'] = 'This setting determines the curriculum in which the modules will appear in the list of modules.';
$string['categoryadded'] = 'The curriculum \'{$a}\' was added';
$string['categorycontents'] = 'Subcategories and courses';
$string['categorycurrentcontents'] = 'Contents of {$a}';
$string['categorydeleted'] = 'The curriculum \'{$a}\' was deleted';
$string['categoryduplicate'] = 'A curriculum named \'{$a}\' already exists!';
$string['categorymodifiedcancel'] = 'Curriculum was modified! Please cancel and try again.';
//$string['categoryname'] = 'Category name';
$string['categoryname'] = 'Curriculum name';
$string['categoryupdated'] = 'The curriculum \'{$a}\' was updated';
...
$string['countryemployment'] = 'Country Of Employment';
$string['course'] = 'Course';
$string['courseadministration'] = 'Module administration';
//$string['courseadministration'] = 'Course administration';
$string['examadministration'] = 'Test administration'; //add by arizan abdullah
...
$string['courseavailable'] = 'This module is available to trainees';
$string['courseavailablenot'] = 'This module is not available to trainees';
...
$string['courseprofiles'] = 'Curriculum(s) / Module(s)';
...
$string['courserestore'] = 'Course upload';
//$string['courserestore'] = 'Course restore';
//$string['courses'] = 'Courses';
$string['courses'] = 'Modules';
$string['listof'] = 'List Of';
$string['coursesectionsummaries'] = 'Course section summaries';
$string['modulecategoriesname'] = 'Module name';
$string['moduleno'] = 'Number of items';
/* $string['coursesettings'] = 'Course default settings'; */
$string['coursesettings2'] = 'Default settings';
...
$string['coursesummary2'] = 'Test summary';
...
$string['courseuploadlimit'] = 'Module upload limit';
$string['create'] = 'Create';
$string['createaccount'] = 'Create my new account';
$string['createcategory'] = 'Create curriculum';
...
$string['edit'] = 'Edit';
$string['edita'] = 'Edit {$a}';
$string['editcategorysettings'] = 'Edit curriculum settings';
$string['editcategorythis'] = 'Edit this program';
...
$string['editmyprofile'] = 'Edit';
$string['profileview'] = 'Profile';
...
$string['editthiscategory'] = 'Edit this curriculum';
...
$string['emailconfirmsent'] = '<p>If you continue to have difficulty, contact the site administrator at CIFAonline.com.</p>';
...
Someone (probably you) requested a new password for your
 \'{$a->sitename}\' account.
...
If the link doesn\'t work, then cut and paste the link into the address line at the top of your web browser
...
$string['emailpasswordconfirmmaybesent'] = '<p>Your request is successful. Check your email for instructions to change your password. Please contact us for further assistance.</p>';
$string['emailpasswordwrong'] = '<p>Your request is unsuccessful. The information you provided did not match the information in our system. Please contact us for further assistance.</p>';
...
$string['emailpasswordconfirmsent'] = '<p>If you continue to have difficulty, contact the site administrator at CIFAonline.com.</p>';
...
$string['emailpasswordsent'] = 'Thank you for verification of request to change password.
A system generate password has been sent to your email.
Please change your password to protect your {$a->sitename} account.';
...
$string['forgotten'] = 'Forgot Password / Candidate ID?';
...
$string['fullnamecourse'] = 'Module full name';
$string['fullnamecourse2'] = 'Exam full name';
...
$string['idnumbercourse2'] = 'Test ID number';
...
//aab
$string['fullpackagesubscibe'] = 'Fullpackage - Online Subscription';
$string['fullpackagesubscibeform'] = 'Enter payment information';
$string['fullpackagesubscibeconfrim'] = 'Subscribe confirmation';

$string['coursecontentsubscibe'] = 'Course Content - Online Subscription';
$string['coursecontentsubscibeform'] = 'Enter payment information';
$string['coursecontentsubscibeconfrim'] = 'Subscribe confirmation';

$string['moduletestsubscibe'] = 'Module Test - Online Subscription';
$string['moduletestsubscibeform'] = 'Enter payment information';
$string['moduletestsubscibeconfrim'] = 'Subscribe confirmation';
//*************
...
$string['loginusing'] = 'Login using your SHAPE<sup>&reg;</sup> Candidate ID and password.';
$string['loginusing2'] = 'Make sure to use ALL CAPITAL LETTERS for Candidate ID. Please ensure there is no confusion on the following character:';
$string['surecapital'] = 'I/1; O/0; Z/2; S/5; B/8; L/1.';
...
$string['mustconfirm'] = 'Administrator need to confirm your payment';
$string['mustchangepassword'] = 'The new password must be different than the current one';
$string['mycourses'] = 'My Training';
// $string['mycourses'] = 'My courses';
//$string['mycourses'] = 'My courses / modules';
$string['currentavailable'] = 'Current Available';
...
$string['manageexamcentre'] = 'Manage Exam Center';
$string['availablecoursemodule'] = 'Available Course Module';
$string['availablemoduletest'] = 'Available Module Test';
$string['availableexam'] = 'Available Test';
$string['listtoken'] = 'List of Trainee With LMS Token';
$string['paymentreceipt'] = 'Payment Receipt';

//add by arizanabdullah
$string['fullnamecourse3'] = 'Module full name';
$string['shortnamecourse3'] = 'Module short name';
$string['course_level3'] = 'Module level';
$string['idnumbercourse3'] = 'Module code';
$string['coursesummary3'] = 'Module summary';
$string['startdate3'] = 'Module start date';
$string['duration3'] = 'Module duration';
$string['examcentrecode'] = 'Exam Center Code';
$string['examcentrecode_help'] = 'This is for enter exam center code. It is related with where exam will be place';
//************************
// $string['myprofile'] = 'My profile';
$string['myprofile'] = 'My Account';
$string['name'] = 'Name';
...
$string['newpasswordtext'] = 'Hi {$a->firstname} {$a->lastname},

Your {$a->sitename} account password reset is successful. Below is your login information:

   Candidate ID: {$a->traineeid}
   Temporary Password: {$a->newpassword}

Please Change Password upon login. If the link doesn\'t work, then cut and paste the below link to the address line at the top of your web browser window.
...
$string['autoresponsesemail'] = 'Dear {$a->fullname},
...
Please note that this is a system generated email. Please  do not reply to this email. For  assistance, please use the <strong><u>{$a->contactuslink}</u></strong> facility  at {$a->sitename} Portal.

Our operation hours are as follows:
Sunday - Thursday : 9.00am - 5.00pm GMT+3
...
$string['expirycoursemonth'] = 'Dear ({$a->firstname} {$a->lastname}),

Candidate ID: {$a->traineeid}

This is a brief reminder that your access to the online training program is due to expire within a month.

Once expired, you will have limited functions in your {$a->sitename}.

If you wish to extend your access to the training program, please proceed by clicking on the {$a->extend} button in the {$a->activetraining} session under {$a->mytraining}.
...
{$a->disclaimer}
';
$string['expirycoursetwoday'] = 'Dear ({$a->firstname} {$a->lastname}),

Candidate ID: {$a->traineeid}

This is a final reminder that your access to the online training program is due to expire within 48 hours. Without it, you will not be able to continue with your training, attempt and pass the IPD Test or access the IPD&#0153; course online. With the expiry, you will also have limited access to the {$a->shapeipdportal}.

If you wish to extend your access to the training program, please proceed by clicking on the {$a->extend} button in the {$a->activetraining} session under {$a->mytraining}. Please note that extend offer is only valid for a period of 30 days from the expiry of your online training program subscription.
...
{$a->disclaimer}
';
$string['expirycourse'] = 'Dear ({$a->firstname} {$a->lastname}),

Candidate ID: {$a->traineeid}

We regret to inform you that your acesss to the online training program has expired and you will not have access to the online training program unless you opt to extend the subscription for the online training programs. This offer is valid for 30 days rom the expiry of your online training program. To extend, simply click the {$a->extend} button in the {$a->activetraining} session under {$a->mytraining}.

You will have limited access to {$a->shapeipdportal}. If you are interested to pursue your training with us, please proceed to {$a->buyipd}.

For more information, kindly {$a->contactuslink} and we will be happy to assist you with your queries.
...
$string['nocoursesyet'] = 'No modules in this curriculum';
...
$string['numberweeks'] = 'Number of topics';
...
$string['parentcategory'] = 'Parent curriculum';
...
$string['passwordforgotten'] = 'Forgotten Password / Candidate ID';
...
$string['passwordforgotteninstructions2'] = 'To reset your password, kindly use the "Password Reset" tool below.';
...
$string['resortcoursesbyname'] = 'Re-sort modules by name';
...
//$string['returningtosite'] = 'Welcome to CIFAOnline';
$string['returningtosite'] = 'Login to IPD Online';
...
$string['traineeid'] = 'User ID';
$string['usertype'] = 'User Role';
$string['usertypeactivetrainee'] = 'Active Trainee';
$string['usertypeinactivetrainee'] = 'Inactive Trainee';
$string['usertypeprospecttrainee'] = 'Prospect Trainee';
$string['usertypegraduatetrainee'] = 'Graduate Trainee';
$string['usertypeofflinetrainee'] = 'Offline Trainee';
$string['usertypetrainer'] = 'Trainer';
$string['usertypeexaminer'] = 'Examiner';
$string['usertypereviewer'] = 'Reviewer';
$string['usertypemarker'] = 'Marker';
$string['usertypeadministrator'] = 'Administrator';
$string['businesspartners'] = 'Business Partners';
$string['institutionalclients'] = 'Institutional Clients';
$string['helpdeskadmin'] = 'Helpdesk Admin';
$string['examcentreadmin'] = 'Exam Center Admin';

$string['usertype_help'] = 'Select user type for new user account';
...
$string['searchby'] = 'Password Reset';
...
$string['shortnamecourse2'] = 'Exam short name';
$string['shortnamecourse_help'] = 'The short name of the module is displayed in the navigation and is used in the subject line of module email messages.';
...
$string['startdate2'] = 'Test start date';
$string['duration2'] = 'Test duration';
$string['duration'] = 'Module duration';
$string['duration_help'] = 'Duration for how long modules is provided';
$string['course_level'] = 'Module Level';
$string['course_level2'] = 'Test Level';
$string['course_level_help'] = 'Level for every modules';
$string['course_type'] = 'Learning type';
$string['course_type_help'] = 'This is types of online learning. We have provided about three type of online learning.';
$string['startdate_help'] = 'This setting determines the start of the first week for a module in weekly format. It also determines the earliest date that logs of module activities are available for.';
...
$string['turneditingoff'] = 'Back to normal pages';
$string['turneditingon'] = 'Start to Edit';
...
$string['uploadthisfile'] = 'Upload file';
$string['url'] = 'URL';
$string['used'] = 'Used';
...
$string['usercurrentsettings'] = 'My account';
...
//$string['usernameoremail'] = 'Enter either candidate id or email address or security question';
$string['enterusername'] = 'Please enter candidate ID';
$string['enteremail'] = 'Please enter email address';
$string['entersq'] = 'Please enter security question';
$string['entersqanswer'] = 'Please enter your security answer';
...
$string['addnewusercategory'] = 'Add new user category';
$string['manageallcurriculum'] = 'Manage all program';
$string['addnewcurriculum'] = 'Add new program';
$string['additionalresources'] = 'Additional resource';
$string['squestion'] = 'Security Question';
$string['sqyouranswer'] = 'Your Answer';
//security question
$string['squestion1'] = 'What is the breed, color and name of your first pet? (eg: ally white piah)';
$string['squestion2'] = 'What school did you attend for fifth grade? (eg: regent international)';
$string['squestion3'] = 'What was your childhood dream job?';
$string['squestion4'] = 'What is the middle name of your youngest sibling?';
$string['squestion5'] = 'What is your oldest sibling`s birthday month and year? (eg: march 1950)';
$string['squestion6'] = 'What is the middle name of your second child?';
$string['squestion7'] = 'In what city or town did your mother and father meet?';
$string['squestion8'] = 'In what city or town was your first job?';
$string['squestion9'] = 'In what city does your nearest sibling live?';
$string['squestion10'] = 'What was your childhood nickname?';
$string['squestion11'] = 'What is your maternal (mother`s side) grandmother`s maiden name?';

/* * ********************************************************* */
$string['addnewuserprofile'] = 'Add new user profile';
$string['educationemployment'] = 'Education Background & Employment Details';
$string['employmentbg'] = 'Employment Background';
$string['educationbg'] = 'Education Background';
$string['completiondate'] = 'Completion Date';

//highest education
$string['highesteducation'] = 'Highest Education';
$string['highesteducation1'] = 'Doctoral degree';
$string['highesteducation2'] = 'Masters degree';
$string['highesteducation3'] = 'Bachelors degree ';
$string['highesteducation4'] = 'Associate degree ';
$string['highesteducation5'] = 'Completed high school ';

//certificate
$string['professionalcert'] = 'Professional Certification';
$string['certificate0'] = 'Chartered Financial Analyst (CFA)';
$string['certificate1'] = 'Chartered Institute of Securities and Investment (CISI)';
$string['certificate2'] = 'Chartered Alternative Investment Analyst (CAIA)';
$string['certificate3'] = 'Chartered Banker Institute';
$string['certificate4'] = 'Certified Management Accountant (CMA)';
$string['certificate5'] = 'The Chartered Institute of Management Accountants (CIMA)';
$string['certificate6'] = 'The Chartered Institute of Public Finance and Accountancy (CIPFA)';
$string['certificate7'] = 'Certified Public Accountant (CPA)';
$string['certificate8'] = 'The Association of Accounting Technicians (AAT)';
$string['certificate9'] = 'The Association of Chartered Certified Accountants (ACCA)';
$string['certificate10'] = 'Certified Public Finance Administrator (CPFA)';
$string['certificate11'] = 'Others (Please specify)';
$string['nameofqualification'] = 'Name of Qualification';


$string['currentprofession'] = 'Current profession / title';

$string['educationbackground'] = 'Education background';
$string['empstatus'] = 'Employment Status';
$string['empname'] = 'Employer Name';
$string['designation'] = 'Designation';
$string['college'] = 'College/University Name';
$string['collegemajor'] = 'College/University Major';
$string['major'] = 'Major';

/* * *************first page- frontpage*********************** */
$string['programname'] = 'Program name';
$string['programcodename'] = 'Program code';
$string['programcoursename'] = 'Module name';
$string['trainername'] = 'Trainer name';
$string['noofcandidate'] = 'No. of candidate';
$string['coursestatus'] = 'Status';
$string['misc.'] = 'Misc.';
$string['certificate'] = 'Certificate';
$string['statement'] = 'Statement';
$string['alertmessage'] = 'Membership has been expired.';

$string['mytrainingprogram'] = 'My Training';
$string['purchaseprogram'] = 'Purchase Program';
$string['financialstatement'] = 'Financial Statement';
$string['feedback'] = 'Feedback';
//$string['changepassword']='Change Password';
$string['mocktest'] = 'Mock Test';
$string['mockexam'] = 'Final Test';
$string['finaltest'] = 'Final Test';
$string['testresult'] = 'Test Result';
$string['mydetails'] = 'My Details';
$string['myaccount'] = 'My Account';
$string['mycandidates'] = 'My Candidates';
$string['mycandidate'] = 'My Account';
$string['newcurriculum'] = 'New Curriculum';
$string['mycommunity'] = 'My Community';
$string['mytraining'] = 'My Training';
$string['activetrainings'] = 'Active Training';
$string['newtrainings'] = 'New Trainings';
$string['myadminroles'] = 'My Admin Roles';
$string['myadmin'] = 'My Admin';
$string['myexamcenter'] = 'My Exam Center';
$string['myfinancial'] = 'My Financial';
$string['mystudents'] = 'My Students';
$string['reactivemembership'] = 'Reactivate My Membership';
$string['paynow'] = 'Pay Now';
$string['myreport'] = 'My Report';
$string['newreport'] = 'Create New Report';
$string['scheduledreport'] = 'Schedule Report';
$string['ipdonlinepolicy'] = 'IPD Online Policy';
$string['cifaonlinepolicy'] = 'IPD Online Policy';
$string['ipdonlinefaq'] = 'IPD Online FAQ';
$string['onlineportal'] = 'IPD Demo';
$string['onlineportalguide'] = 'IPD Demo';
$string['examresult'] = 'Exam / Test Results';
$string['examresultcifa'] = 'Exam Results';
$string['examstatement'] = 'Exam Statement';
$string['examregulation'] = 'Exam Rules & Regulation';
$string['examguide'] = 'Mock Exam & Exam Guide';
$string['employmentbackground'] = 'Employment & Educational Background';
$string['candidateprogress'] = 'Candidate Progress';
$string['resetpassword'] = 'Candidate Password';
$string['updatecandidateinfo'] = 'Candidate Profile';
$string['resetpword'] = 'Reset Password';
$string['updatedetails'] = 'Update Profile';
$string['cifaexamportal'] = 'CIFAExam Portal';
$string['result'] = 'Result';
$string['viewresult'] = 'View Result';
$string['timestart'] = 'Start (Date/Time)';
$string['timefinish'] = 'End (Date/Time)';
$string['marks'] = 'Marks (%)';
...
$string['durations'] = 'Duration (hh:mm:ss)';

$string['learningoutcome'] = 'Learning Outcome';
$string['questions'] = 'Questions';
$string['questionsattempted'] = 'Questions Attempted';
$string['score'] = 'Score (%)';


$string['ifforums'] = 'IF Forums';
$string['youtube'] = 'Youtube';
$string['socialnetwork'] = 'Social Media';
$string['feedbackreview'] = 'Feedback & Review';

$string['personaldetails'] = 'Personal Details';
$string['profile'] = 'Profile';
//$string['changespassword']='Password';
$string['examcentre'] = 'Exam Center';
$string['candidatemanagement'] = 'Candidate Management';
$string['downloadexamsoftware'] = 'Exam Software';
$string['uploadexamresult'] = 'Upload Result';
$string['paymentrecords'] = 'Manage Payment Records';
$string['cifachat'] = 'IPD Chat';
$string['cifablog'] = 'CIFABlog';
$string['chooseafile'] = 'Choose a file to upload';
$string['uploadresult'] = 'Upload Test Result';
$string['cifacurriculum'] = 'CIFA Curriculum';
$string['shapeipd'] = 'Shape Ipd';
$string['ipdprogram'] = 'IPD program';
$string['ipdcourses'] = 'IPD Courses';

$string['manageprogram'] = 'Manage Program/Module';
$string['addnewmodule'] = 'Add New Module';
$string['testresults'] = 'Test Results';
$string['enrollnow'] = 'Enroll Now';
/* * ********************************************************* */
$string['name'] = 'Name';
$string['candidateid'] = 'Candidate ID';
$string['membershipexpiry'] = 'Membership Expiry';
$string['tokenid'] = 'Token ID';
$string['tokenexpiry'] = 'Token Expiry';
$string['norecords'] = 'No records found.';
$string['registedcandidates'] = ' View registed candidates';
$string['fillbox'] = 'Please fill the search box with candidate ID!';
$string['purchaseaprograms'] = 'Purchase a Training Program';

$string['titlename'] = 'Title';
$string['companyname'] = 'Company name';
$string['jobtitle'] = 'Job title';
$string['workemail'] = 'Work email';
$string['email1'] = 'Email';
$string['worktel'] = 'Work phone';
$string['workfax'] = 'Work Fax';
$string['mobiletel'] = 'Phone (Mobile)';
$string['hometel'] = 'Home phone';
$string['mobiletel'] = 'Mobile';
$string['officetel'] = 'Phone (Daytime)';
$string['contactno'] = 'Contact. no';
$string['faxno'] = 'Fax. no';
$string['zip'] = 'Postcode/Zip';
$string['institutiondetails'] = 'Institution Details';

$string['activitylog'] = 'Log Activity Report';
$string['assignusersroles'] = 'Assign System Roles';
$string['manualenrolments'] = 'Manual Enrollments';
$string['manualuserenrolment'] = 'Manual Users Enrollment';
$string['enrolcandidates'] = 'Enroll Now';
$string['enrolledusers'] = 'Enrolled Users';
$string['enrolmentconfirmation'] = 'SHAPE<sup>&reg;</sup> Enrollment Confirmation';
$string['enrollconfirmation'] = 'Enrollment Confirmation';
$string['ecblockbar'] = 'Enrollment Confirmation';
$string['communicationpreferences'] = 'Communication Preferences';
$string['transactionstatus'] = 'Transaction Status';
$string['paymentmethod'] = 'Payment Method';
$string['coursemodule'] = 'Enrolled Program';
$string['datepurchase'] = 'Enrollment Date';

$string['myexams'] = 'My Exams';
$string['adminmodules'] = 'Modules';
$string['adminexams'] = 'Exams';
$string['yearcomplete'] = 'Year Completed';
$string['empstartdate'] = 'Start Date';
$string['empenddate'] = 'End date';
$string['yearinfield'] = 'Years of experience';

$string['evaluation'] = 'Evaluation';
$string['working'] = 'Working';
$string['notworking'] = 'Not working';

$string['emailpartenrolmentmsj'] = 'Thank You! Your part-enrollment is successful.<br/> The Part-enrollment statement will be sent to you within 24 hours.';
$string['emailenrolmentmsj'] = 'Thank You! Your order has been placed.<br/> Email confirmation will be sent to you within 24 hours.';
$string['textpayment'] = 'Kindly remit payment within 4 weeks of completing the process online to avoid order cancellation. Once you have remitted your payment, please send a copy of the bank transfer slip together with your Candidate ID to {$a}';
$string['orderconfirmationtitle'] = 'Order Confirmation';
$string['moduleprice'] = 'Module price';
$string['changeprice'] = 'Change price';
$string['saveprice'] = 'Save price';
$string['communicationpreferenceupdated'] = 'Your communication preference have been updated.';

$string['footertextshape'] = '
<strong>SHAPE<sup>TM</sup> IPD - Islamic Professional Development</strong><br/>
				Developed by SHAPE for Economic Consulting, W.L.L
';
$string['footertextcifa'] = '
<strong>All Rights Reserved&copy;<br/>
				Developed by SHAPE<sup>&reg;</sup> Knowledge Services</strong>
';
/* $string['footertextcifa']='
  <strong>CIFA - Certified Islamic Financial</strong><br/>
  Developed by SHAPE for Economic Consulting, W.L.L
  '; */
$string['transactionreport'] = 'Transaction Report';
$string['confirmationno'] = 'Order Confirmation No.';
$string['continuemypurchases'] = 'Continue My Purchase';
$string['mypurchase'] = 'My purchase';
$string['student'] = 'Student';
$string['prospect'] = 'Prospect Status';
$string['cert.'] = 'Certificate';

$string['modulenameprogress'] = 'Coursename';
$string['subscribeddate'] = 'Subscribed date';
...
$string['messagesubject'] = 'Add a subject';
$string['contactname'] = 'Full Name';
$string['contactsubject'] = 'Subject';
$string['messagecontent'] = 'Message';

$string['no'] = 'No';
$string['usersrole'] = 'User role';
$string['addusers'] = 'Add User';
$string['managecategoryusers'] = 'Manage category / user';
$string['addcurriculummodule'] = 'Add curriculum / module';
$string['gender'] = 'Gender';
$string['male'] = 'Male';
$string['female'] = 'Female';
$string['welcomenote'] = "Welcome to IPD Online";
$string['buyacifa'] = "Buy IPD";

$string['subscriptionstart'] = 'Subscription start';
$string['subscriptionend'] = 'Subscription end';
$string['mypicture'] = 'Picture';
$string['print'] = 'Print';

$string['examrules'] = 'Exam Rules';
$string['resitexam'] = 'Re-sit Test';
$string['cifaworkspace'] = 'IPD Online';
$string['learncifa'] = 'LearnCifa.com';

$string['useroption'] = 'User Option';
$string['existingcandidate'] = 'Existing Candidate';
$string['newenrolment'] = 'New Enrollment';
$string['candidateinfo'] = 'Candidate Info';
$string['printnote'] = 'NOTE: This is computer generated. Signature is not required.';

$string['compreference1'] = 'Disclosure of status to third parties if we are approached by employers and recruitment consultants to verify the CIFA&#8482; status of job candidates.<font color="red"> *</font>';
$string['compreference2'] = 'I want to receive promotional e-mails (e.g. training programs, recruitment, opportunities etc). Your details will not be passed to third parties. ';
$string['compreference3'] = '{$a}';
$string['compreference3_1'] = 'I have read, understood and agree to the ';
$string['compreference3_2'] = '<font color="red"> *</font>';

$string['banktransferinfo'] = '

Branch						:	Sharq Branch
Account Title/Beneficiary	:	Alinmaa Education Co W.L.L
SWIFT Code					:	KWKWBBYN
IBAN # 						:	KW12 BBYN 0000 0000 0000 0149 0840 01
Account Number				:	0149084001
Reference					:	SHAPE Financial Corporation

You will be liable for the additional charges incurred in the wire transfer.<br/><br/>
Kindly remit payment within 4 weeks of completing the process online to avoid order cancellation. Once you have remitted your payment, please send a copy of the bank transfer slip together with your Candidate ID to {$a}
';

$string['uploadfacility'] = 'Upload Facility';
$string['contactus'] = 'Contact Us';
$string['submitmessage'] = 'Submit';
$string['manualemailconfig'] = 'Manual Email Configuration';
$string['emailactivity'] = 'Email Activity';
$string['emailcontentconfig'] = 'Email Content Config';

$string['orgtype'] = 'Organization';
$string['listoforg'] = 'List Of Organization';
$string['addneworg'] = 'Add New Organization';
$string['instregistration'] = 'Institution Registration';
$string['save'] = ' Save ';
$string['examinationtitle'] = 'Test Title';
$string['cifaexamination'] = 'SHAPE<sup>&reg;</sup> IPD Test Results';
$string['reactivenow'] = 'Reactive Now';
...
$string['startdateregistration'] = 'Start Date';
$string['enddateregistration'] = 'Expiry Date';

$string['contactdob'] = 'D.O.B (DD:MM:YY)';
$string['ifstillcannotlogging'] = 'If you still have trouble logging in, please complete the {$a} form below.';

$string['news_update'] = 'News & Update';
$string['addnews_update'] = 'Add News & Update';
$string['listofnews_update'] = 'List Of News & Update';

$string['tokentitle'] = 'SHAPE<sup>&reg;</sup> Examination Candidate Database';
$string['tokendownloadsuccesful'] = 'Token Download Successful';
$string['tokennotice'] = '<strong>Notice: </strong>For multiple token downloads or schedulling oline exams, select candidates and click the relevant buttons on top-right of the page';
$string['candidateexamsummary'] = 'Candidate Test Summary';
$string['chooseshapeprogram'] = 'Choose SHAPE<sup>&reg;</sup> Program';
$string['allshapeprogram'] = 'All Shape<sup>&reg;</sup> Program';

$string['olinebookexam'] = 'Online Examination Booked Successfully';
$string['onlineexam'] = 'Online Exam';

$string['uploadresult'] = 'Upload Result';
$string['examresultupload'] = 'Exam Result Upload';
$string['chooseupload'] = 'Choose a result file to submit to server. <br/>Eg: exam_result.csv';
$string['creatednewreport'] = 'New Report';
$string['reportname'] = 'Report Name';
$string['reportmanagement'] = 'Report Management';
$string['createdby'] = 'Created By';
$string['creationdate'] = 'Creation Date';
$string['modulecompleted'] = 'Module Completed';
$string['progressreport'] = 'Progress Report';
$string['viewprogress'] = 'Click Here To View Progress Report';
$string['recipient'] = 'Recipient';
$string['sendschedule'] = 'Send Schedule';
$string['newschedule'] = 'New Schedule';
$string['schedulingreport'] = 'Scheduling for';
$string['newnotice'] = 'New Scheduling Created';
$string['editnotice'] = 'Scheduling Update Successful';
$string['olineexamschedulling'] = 'Online Exam Schedulling';
$string['organization'] = 'Organization';
$string['schedulenotice'] = '<strong>Notice: </strong>For multiple report recipients, repeat the search and select function. Click confirm to scheduling';
$string['recipientdetails'] = 'Recipient Details';
$string['dateofbirth'] = 'Date of Birth';
$string['orgname'] = 'Organization Name';
$string['scheduling'] = 'Scheduling';
$string['daily'] = 'Daily';
$string['weekly'] = 'Weekly, on the day';
$string['monthly'] = 'Monthly on the day';
$string['specificdate'] = 'Specific Date';
$string['titlesoft'] = 'Software Download';
$string['reportdeletedsuccessfully'] = 'Report Deleted Successfully';
$string['manageexamregister'] = 'Manage Candidate For Exam Registration';
$string['examtokenexpiry'] = 'Exam Token Expired';
$string['notusedtoken'] = 'No result found';
$string['updateprofile'] = 'Update Profile';
$string['candidatedetails'] = 'Candidate Details';
$string['reportmenu'] = 'Report Menu';
$string['newreportindividualnotice'] = '<strong>Notice: </strong>For multiple candidates, repeat the search and select process. Confirm to progress.';
$string['newreportorgnotice'] = '<strong>Notice: </strong>For multiple organization, repeat the search and select process. Confirm to progress.';

$string['cifacandidatemanagement'] = 'SHAPE<sup>&reg;</sup> Candidate Management';
$string['ccmanagement'] = 'Candidate Management';
$string['cifacandidatedatabase'] = 'SHAPE<sup>&reg;</sup> Candidate Database';
$string['multiplepwordresetnotice'] = '<strong>Notice: </strong>For multiple password reset, select candidates and Reset Password button on top-right of the page';
$string['reporttimelinenotice'] = '<strong>Notice: </strong>For progress report that require scheduling, please leave this section BLANK';
$string['reportoptionnotice'] = '<strong>Notice: </strong>Please select the desired reporting options below';
$string['resetsuccessful'] = 'Password Reset Successful';
$string['checktodownload'] = 'Please check the box to download.';

$string['passwordpolicytext'] = 'The password must have AT LEAST 8 characters, one CAPITAL letter (A-Z), one lower case letter(a-z), and one digit(0 - 9)';

$string['disclaimer'] = 'Disclaimer: Please note this is a computer generated statement. Signatured is not required.';
$string['eguide'] = 'Exam Guide';
$string['erules'] = 'SHAPE<sup>&reg;</sup> Exam Rules and Regulations ';

$string['examrulesloggin'] = 'Loggin require to view this page';
$string['idletime'] = 'You have been idle for 15 minutes. System will logout automatically';
$string['enrollmentprogram'] = 'List of SHAPE<sup>&reg;</sup> Program Enrollment';
$string['contactusmessage'] = 'Thank you for your email, we will revert back to you within 72 hours';

$string['logoutnotice'] = '<span style="font-weight:bolder;color:#FF5757;">Notice:</span> System will log out if you take more than 15 minutes to complete the enrollment process.';
$string['viewstatement'] = 'View Statement';
$string['fs_word1'] = 'The amount detailed below has been received with thanks for the following transaction:';
$string['fs_word2'] = 'Should you require futher assistance, {$a}. We will be pleased to help.';
$string['title'] = 'Title';
$string['startdemo'] = 'Start';
$string['demo'] = 'Demo';
$string['ip_address_help'] = "
...
Note: Dont let the plethora of numbers and addresses confuse you.The value you are interested to determine the computers IP address is the IPv4 Address.
...
";
$string['searchresultnotfound'] = 'Search result not found';
$string['titledownload'] = 'Click to download';
$string['softwaredownload'] = 'Software';
$string['examtokenexpired'] = 'Exam Token Expired';
$string['editexamrules'] = 'Edit IPD Online FAQ';
$string['viewipdfaq'] = 'View IPD Online FAQ';
$string['editenrolmentconfirmation'] = 'Edit Enrollment Confirmation';
$string['editcifaonlinepolicy'] = 'Edit IPD Online Policy';
$string['editusercertificate'] = 'Edit Certificate';
$string['editfinancialstatement'] = 'Edit Financial';

//extension//re-sit
$string['extension'] = '(Extension)';
$string['re_sit'] = '(Re-sit)';
$string['onlineexamschedule'] = 'Online Exam Schedule';
$string['New Schedulling'] = '';

$string['curriculumcode'] = 'Course Code';
$string['modulescompleted'] = 'Modules Completed';
$string['examstatus'] = 'Exam Status';
$string['attempts'] = 'Attempts';
$string['examscore'] = 'Score';
$string['teststatus'] = 'Test Status';

$string['ipdcourseperformance']='IPD Course Performance';
$string['passes'] = 'Passes';
$string['passrate'] = 'Pass rate';
$string['coursecode'] = 'Course Code';
$string['coursetitle'] = 'Course Title';
$string['testattempts'] = 'Test Attempts';
$string['scorelo'] = 'Score On Learning Outcome';
$string['lo'] = 'Learning Outcome';

$string['chooseipdshape'] = 'Choose SHAPE<sup>&reg;</sup> IPD Courses';
$string['allipdcourses'] = 'All IPD Courses';
$string['shapeipdcoursestitle'] = 'SHAPE<sup>&reg;</sup> IPD Courses Title';
$string['testtokenid'] = 'Test Token ID';
$string['testdatetime'] = 'Test (Date/Time)';
$string['viewdemo'] = 'View Demo';
$string['ipddemo'] = 'IPD Demo';

$string['mcsocialnetworking'] = 'Be part our online community and get latest update on SHAPE<sup>&reg;</sup> and the Islamic Finance Industry';
$string['certtext'] = 'This course is part of the SHAPE<sup>&reg;</sup> Islamic Professional Development(IPD) Program';

$string['failtest'] = 'Fail';

$string['ipdonline'] = 'IPD Online';
$string['ipdaddress'] = "
Tel: +965 2291 5580<br/>
Fax: +965 2291 5581<br/>
www.consultSHAPE.com<br/>
P.O. Box 29916, Safat 13159, <br/>
Kuwait City, Kuwait
";

$string['candidateperformance'] = 'Candidate Performance';
$string['reporttimeline'] = 'Reporting Timeline';
$string['temporarypassword'] = 'Password01';
$string['newschedulling'] = 'New Schedulling';
$string['viewcertconfiguration'] = 'View Certification Configuration';
$string['registedorganization'] = 'Registered Organization';
$string['allowtoviewcert'] = 'Allow to View Cert.';
$string['configurationupdate'] = 'Configuration updated';

$string['ipdemail'] = "info@consultshape.com";
$string['employeeid'] = "Employee ID";
$string['subscriptiondate'] = "Course Subscription Date";
$string['expirydate'] = "Course Expiry Date";
$string['extendedcourse'] = "Extend";

$string['welcome_email_adib_text'] = '
{$a->logo}

Dear {$a->firstname} {$a->lastname} ({$a->traineeid}),
    
We are pleased to confirm your enrollment in the following E - Learning Program: Islamic Banking I mandatory program. 

Please be guided by the following:

i.    If you require further validation or any other inquiry for this system notification please contact ADIB Academy at {$a->link} or contact Racha Al Ries extension 20184

ii.   Mock test: You are required to attempt the 5 questions in the mock test prior to the final test. This will assist you in familiarizing yourself with the online based testing and understand examiner expectation.

iii.  Final Test:  You are entitled to 2 attempts. The test consist of 20 Multiple Choice Questions (MCQ) with a time limit of 30 minutes. Once the time elapses, the test will terminate immediately. The test must be completed within one session. It cannot be resumed later.

iv.   Passing Mark: The pass mark for the course is 75%. Your test result will be based on the latest attempt. Therefore your 2nd attempt result will override the 1st attempt result.

v.    Time Requirement: Please allocate enough time to go through the assessments and the module; we recommend a minimum of 2 hours.

vi.   Saving Your Progress: Your progress will be saved upon completing a section. If you quit before completing a section, you will have to go through the section again. Upon completing all 6 sections, you will be redirected to an assessment, on which your answers will be saved and submitted in one sitting. If the assessment is not completed in one sitting, you will have to retake the assessment.

vii.  IT Requirements: Flash Player version 10 or above should be installed in the user desk/laptop for the program to run if not please contact ITD Help Desk for assistance.

viii. Tracking & Monitoring: Your access of the e-learning program and scores you get are being monitored centrally by the Learning & Development Department. For further queries or any assistance, please contact Learning & Development Department at extensions 20184

ix.   Cost: Registration is USD 65, test re-sit and course extension at USD 40 and re-registration at USD65. Please contact Learning & Development Department at extensions 20184 or email BankingAcademy@adib.com for more information and assistance 

Please ensure you complete your e-learning within 30 days from receiving this notification. 

Regards,
Banking Academy
';

$string['welcome_email_text'] = 'Dear {$a->firstname} {$a->lastname},
    
IPD Candidate ID: {$a->traineeid}
Temporary password: {$a->newpassword}
    
I am pleased to welcome you as a new candidate to Islamic Professional Development (IPD) Training Program.

You have taken the first step to enhance your knowledge in Islamic Finance. Your Candidate ID is <strong>{$a->traineeid}</strong>. Please quote this in all future correspondence with us. You may proceed to the first time login to your IPD Online by using the Candidate ID and the temporary password given in this email.

IPD Online enables you access to the online training portal, update personal details i.e. address/email, participate in the community activities, access to candidate support area, attempting your test online, viewing your result and certification.

Since you have opted for IPD, you will be entitled to Certificate of Completion for each course you pass. You will not be required to take other examination as it is not part of the program requirement.

However, along the way if you wish to enroll for  the {$a->cifa} Certification program, you may proceed to  purchase the CIFA Curriculum Trainings. For more information on {$a->cifa}  Curriculum, please visit {$a->websiteurl}

As an active IPD Candidate, you may start your IPD  courses via <u>Active Training</u> link under <strong>&quot;My Training&quot;</strong>. You will be able to see the SHAPE<sup>&reg;</sup> IPD courses that  you have chosen. Click on the <strong>LAUNCH</strong> button to begin your training.

You may now proceed to login to your IPD Online  using the link below
{$a->link}
...
$string['reminder_notcomplet_course'] = 'Dear {$a->firstname} {$a->lastname}, Greetings from SHAPE<sup>&reg;</sup>
    
IPD Candidate ID: {$a->traineeid}
    
This is a brief reminder that you have not completed the SHAPE<sup>&reg;</sup> Foundation of Islamic Banking & Finance e-learning course and the access is due to expire by {$a->expirydate}. Once expired, you will not be able to access the course online or take the test.

The final test and test strengthen your knowledge in Islamic Banking. The test is part of the online course, hence no additional payment is required. Each candidate will be entitled to 2 test opportunities and mock test to familiarize yourself with the online testing environment. To launch the test, simply click the <u>Final Test</u> link available under <strong>My Training</strong> at the home page.

Please note the test validity is same with the course subscription period. After which, the unused test token will expire and you will not have access to the online course or the test.

To start the course and attempt the test, login to the SHAPE<sup>&reg;</sup> (IPD) portal with your provided username and password via the following link: <strong><u>{$a->link}</u></strong>

If you have forgotten your username and/or password, click on the forgotten password link at the login page for immediate assistance.

We wish you all the best and hope to continuously support you throughout your training with us.
...
$string['reminder_notstart_LMS'] = 'Dear {$a->firstname} {$a->lastname}, Greetings from SHAPE<sup>&reg;</sup>
    
IPD Candidate ID: {$a->traineeid}
    
This is a brief reminder that you have not started the SHAPE<sup>&reg;</sup> Foundation of Islamic Banking & Finance e-learning course and the access is due to expire by {$a->expirydate}. Once expired, you will not be able to access the course online or take the test.
...
{$a->disclaimer}
';
$string['schedule_emailtext'] = 'Dear {$a->firstname} {$a->lastname}, Greetings from SHAPE<sup>&reg;</sup>
    
New report has been generate today. To download, please click on link below:
{$a->linkdownload}
...
// Maintenance email for changing url
$string['lms_schedule_maintenance'] = 'Dear {$a->firstname} {$a->lastname}
    
Candidate ID: {$a->traineeid}
    
We will be performing several updates on our LMS this {$a->startdatetimemaintenance}. The maintenance is required in order to keep our LMS up-to-date. In the following period all access to the IPDOnline LMS will be suspended.

    * Date & Time: {$a->datetimemaintenance}

After the upgrade, IPDOnline LMS will resume service using the new web url: {$a->link}

For any enquiries and concerns, please send email to {$a->consultshapelink}

Thank you for your attention and we are sorry for any inconvenience caused.
...
$string['manual_sendingmail'] = 'Dear {$a->firstname} {$a->lastname}, Greetings from SHAPE<sup>&reg;</sup>
    
IPD Candidate ID: {$a->traineeid}
    
Please login to IPD Online LMS to proceed your courses. LAUNCH button now available to you.
...
$string['strlogin'] = 'Log on Info';

// Manage Organization Database
$string['organizationdb'] = 'Manage Organization Database';
$string['insertinto'] = 'Insert Into';
$string['organizationid'] = 'Organization ID';
$string['businesspartner'] = 'Business Partner';
$string['institutionalclient'] = 'Institutional Client';
$string['examcenter'] = 'Exam Center';
$string['registrationdate'] = 'Registration Date';
$string['chooseone'] = 'Choose one';
$string['organizationsize'] = 'Organization Size';
$string['organizationtype'] = 'Organization Type';
$string['orgindustry'] = 'Industry';
$string['totalusersubscribed']='Total User Subscribed';
$string['totalcoursesubscribed']='Total Course Subscribed';
$string['organizationrole'] = 'Organization Role';
$string['hqorganizationid'] = 'HQ Organization ID';
...
$string['miss'] = 'Miss';
$string['dateofbirth'] = 'Date of Birth';
$string['daytimetel'] = 'Daytime Tel';
$string['studiesstartdate'] = 'Studies Start Date';
$string['studiescompdate'] = 'Studies Completion Date';
$string['oldusername'] = 'Old Username';
$string['outstandingbalance'] = 'Outstanding Balance';
$string['enrolmentsource'] = 'Enrollment Source'; 
$string['datejoinorganization'] = 'Date Joined Organization';
$string['recordsnotfound'] = 'Records not found';

// Support Management Activities
$string['supportactivities'] = 'Support Management Activities';
$string['support'] = 'Support';
$string['supportcategory'] = 'Category';
$string['attachment'] = 'Attachment';
$string['financialhistory'] = 'Financial History';
$string['coursehistory'] = 'Course History';
$string['supportid'] = 'Support ID';
$string['statusopen'] = 'Open';
$string['statusclose'] = 'Close';
$string['statuspending'] = 'Pending';
$string['seconfirmation'] = 'SHAPE Enrollment Confirmation';

$string['transactionid'] = 'Transaction ID';
$string['debit'] = 'Debit (USD)';
$string['credit'] = 'Credit (USD)';
$string['billed'] = 'Billed';
$string['paid'] = 'Paid';

$string['enrolmentdate'] = 'Enrollment Date';
$string['subscriptionstartdate'] = 'Subscription Start Date';
$string['subscriptionendate'] = 'Subscription End Date';
$string['serviceby'] = 'Service By';
$string['passed'] = 'Passed';
$string['failed'] = 'Failed';
$string['expired'] = 'Expired';
$string['openstatus'] = 'Open';
$string['testresit'] = 'Test Re-sit';
$string['resitmessagetext'] = 'Test re-sit success update';
$string['ipdcert'] = 'IPD Cert';
$string['courseextensiontext'] = 'Course Extension Successful ';
$string['testsittext'] = 'Test-sit Successful ';
$string['checkatleastone'] = 'Please select at lease one ';

$string['activityid'] = 'Activity ID';
$string['inperson'] = 'In-person';
$string['webinar'] = 'Webinar';
$string['elearning'] = 'E-learning';
$string['systememail'] = 'System Email';
$string['event'] = 'Event';
$string['emailblast'] = 'Email Blast';
$string['telemarketing'] = 'Telemarketing';
$string['deletetextmsg'] = 'Delete Successful';
$string['newaddedtextmsg'] = 'New Activity Successful added';
$string['bulkenrolment'] ='Bulk Enrolment';

$string['communicationtitle'] ='Communication Title';
$string['reporttitle'] ='Report Title';
$string['roletitle'] ='Role Title';
$string['assigneduser'] ='Assigned User';
$string['assign'] ='Assign';
$string['communicationhome_process'] = 'Communication Home Process: {$a->buttonname}';

$string['production'] = 'Production';
$string['addnewschedule'] = 'Add New Schedule';
$string['individual'] = 'Individual';
$string['unselectall'] = 'Unselect All';
$string['recurrencetimeline'] = 'Recurrence Timeline';
$string['emailschedulenotice'] = 'For multiple {$a->utype}, repeat the search and select process. Confirm to progress';
$string['recurrencetimelinenotice'] = 'Please leave this section blank if no recurrence timeline applies and click <strong>Preview Message</strong> to progress';
$string['previewmessage'] = 'Preview Message';
$string['enrolstatus'] = 'Enrol Status';
$string['schedulemonthly'] = 'schedulemonthly';
$string['scheduleweekly'] = 'scheduleweekly';

$string['attachments'] = 'Attachment(s)';
$string['subject'] = 'Subject';
$string['message'] = 'Message';
$string['signature'] = 'Signatures';
$string['receiveacopy'] = 'Receive a copy';
$string['candidatedetail'] = 'Candidate Detail'; 
$string['assigned'] = 'Assigned'; 
$string['userroleedit'] = 'User Role Process: Edit';
$string['downloadhtml'] = 'HTML';
$string['downloadexcel'] = 'EXCEL';
$string['downloadcsv'] = 'CSV';
$string['finalstep'] = 'Final Step';
$string['salesservices'] = 'Sales & Services ';
$string['saved'] = 'Saved ';
$string['send'] = 'Send ';

$string['disclaimer'] = 'This is a system generated email, please do not reply. For assistance, {$a->contactuslink} or email us at {$a->emailus} with your Candidate ID and full name and we will revert back to you within 72 hours';