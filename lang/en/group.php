...
The group mode defined at module level is the default mode for all activities within the module. Each activity that supports groups can also define its own group mode, though if the group mode is forced at module level, the group mode setting for each activity is ignored.';
