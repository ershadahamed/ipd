...
$string['configextendedusernamechars'] = 'Enable this setting to allow trainees to use any characters in their usernames (note this does not affect their actual names).  The default is "false" which restricts usernames to be alphanumeric lowercase characters, underscore (_), hyphen (-), period (.) or at symbol (@).';
...
$string['confighiddenuserfields'] = 'Select which user information fields you wish to hide from other users other than course trainers/admins. This will increase trainee privacy. Hold CTRL key to select multiple fields.';
...
$string['configrequestedstudentname'] = 'Word for trainee used in requested courses';
$string['configrequestedstudentsname'] = 'Word for trainees used in requested courses';
...
$string['configrestrictmodulesfor'] = 'Which courses should have <b>the setting</b> for disabling some activity modules?  Note that this setting only applies to trainers, administrators will still be able to add any activity to a course.';
...
$string['configshowsiteparticipantslist'] = 'All of these site trainees and site trainers will be listed on the site participants list. Who shall be allowed to see this site participants list?';
...
$string['coursemgmt2'] = 'Add/edit module test';
$string['coursemgmt_exam'] = 'Add/edit exam';
$string['coursemgmt_category'] = 'Manage categories';
/*$string['coursemgmt'] = 'Manage courses / Module test';*/
$string['addnewcategory'] = 'Add new category';
//added by arizanabdullah
$string['addnewexam'] = 'Add a new exam';
$string['editcoursesettings'] = 'Edit exam settings';
$string['editcoursesettings2'] = 'Edit module test settings';
...
//$string['coursesmoduletest'] = 'Courses / Module Test';
...
$string['hidefromstudents'] = 'Hide from trainees';
...
/*add by arizan*/
$string['listoftoken'] = 'List of user token';
$string['paymentstatus'] = 'Manage trainees registration';
...
$string['defaultmypage'] = 'Default My page';
...
$string['uulegacy1role'] = '(Original Trainee) typeN=1';
...
$string['uploadbulkuser']='Upload Users';
$string['candidateperformance']='Candidate Performance';
$string['certconfig']='Cert. Configuration';

$string['monthlyreport'] = 'Monthly Report';
