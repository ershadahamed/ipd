...
$string['backupactivity'] = 'Download activity: {$a}';
$string['backupcourse'] = 'Download course: {$a}';
...
$string['backupdetails'] = 'Download details';
...
$string['backupstage4action'] = 'Perform download';
...
$string['choosefilefromcoursebackup'] = 'Course download area';
...
$string['choosefilefromuserbackup'] = 'User private download area';
...
$string['choosefilefromactivitybackup'] = 'Activity download area';
...
$string['currentstage8'] = 'Perform download';
...
$string['executionsuccess'] = 'The software was successfully created.';
...
$string['importfile'] = 'Import a download file';
...
$string['managefiles'] = 'Manage download files';
...
$string['restoreactivity'] = 'Upload activity';
$string['restorecourse'] = 'Upload course';
...
$string['restorerootsettings'] = 'Upload settings';
$string['restoresection'] = 'Upload section';
...
$string['restorestage16action'] = 'Perform upload';
