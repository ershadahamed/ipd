...
$string['informminpassworddigits'] = 'and one digit(0 - 9)';
$string['informminpasswordlength'] = 'AT LEAST {$a} characters';
$string['informminpasswordlower'] = 'one lower case letter(a-z)';
$string['informminpasswordupper'] = 'one CAPITAL letter (A-Z)';
