<?php
	...
	if($rowEmail['name']=='smtphosts'){ echo $smtpEmail=$rowEmail['value']; }
	if($rowEmail['name']=='smtpuser'){ echo $smtpUser=$rowEmail['value']; }
	if($rowEmail['name']=='smtppass'){ echo $smtppass=$rowEmail['value']; }
