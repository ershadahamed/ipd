...
class admin_uploaduser_form2 extends moodleform {
    function definition () {
		...
		if(($USER->id) == '2'){ //add by arizan abdullah on 27/2/2012
        $mform->addElement('header', 'settingsheader', get_string('settings'));
		}else{
		$mform->addElement('hidden', 'settingsheader', get_string('settings'));
		}
		...
		$mform->addElement('hidden', 'uutype', get_string('uuoptype', 'admin'), $choices);
		}
		...
		$mform->addElement('hidden', 'uupasswordnew', get_string('uupasswordnew', 'admin'), $choices);
		}
		...
		$mform->addElement('hidden', 'uuupdatetype', get_string('uuupdatetype', 'admin'), $choices);
		}
		...
		$mform->addElement('hidden', 'uupasswordold', get_string('uupasswordold', 'admin'), $choices);
		}
		...
		$mform->addElement('hidden', 'uuforcepasswordchange', get_string('forcepasswordchange', 'core'), $choices);
		}
		...
		$mform->addElement('hidden', 'uuallowrenames', get_string('allowrenames', 'admin'));
		}
		...
		$mform->addElement('hidden', 'uuallowdeletes', get_string('allowdeletes', 'admin'));
		}
		...
		$mform->addElement('hidden', 'uunoemailduplicates', get_string('uunoemailduplicates', 'admin'));
		}
		...
		$mform->addElement('hidden', 'uustandardusernames', get_string('uustandardusernames', 'admin'));
		}
		...
		$mform->addElement('hidden', 'uubulk', get_string('uubulk', 'admin'), $choices);
		}
		...
		$mform->addElement('hidden', 'idnumber', get_string('idnumber'), 'maxlength="64" size="25"');
		}
