...
//added by arizan abdullah 20121126
	...
	if($rowuserrole['id'] == '5'){ $usergroup='A'; }
	else if($rowuserrole['id'] == '3'){ $usergroup='B'; }
	else if($rowuserrole['id'] == '4'){ $usergroup='C'; }
	else if($rowuserrole['id'] == '10'){ $usergroup='D'; }
	else if($rowuserrole['id'] == '11'){ $usergroup='E'; }
	else if($rowuserrole['id'] == '12'){ $usergroup='F'; }
	else if($rowuserrole['id'] == '13'){ $usergroup='G'; }
