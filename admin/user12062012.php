<?php
	...
	$stredit = '<img src="../image/edit.png" width="25">';
    //$strdelete = get_string('delete');
	$strdelete = '<img src="../image/delete.png" width="25">';
    ...
    if (!empty($table)) {
       ...
       /* if (has_capability('moodle/user:create', $sitecontext)) {
		...
		/*if (has_capability('moodle/user:create', $sitecontext)) {
            echo $OUTPUT->heading('<a href="'.$securewwwroot.'/userfrontpage/useraddcategory.php">'.get_string('addnewusercategory').'</a>');
        }*/
		...
		/*if (has_capability('moodle/user:create', $sitecontext)) {
			$goback='Go Back';
			//echo '<input type="button" name="goback" value="'.$goback.'" ONCLICK="history.go(-1)"';
            echo $OUTPUT->heading('<a href="#" ONCLICK="history.go(-1)">'.$goback.'</a>');
        }*/
    }
    echo $OUTPUT->footer();
	//add aa
