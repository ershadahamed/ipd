...
if ($hassiteconfig
 ...
 or has_capability('moodle/site:approvecourse', $systemcontext)) { // speedup for non-admins, add all caps used on this page
	...
	$ADMIN->add('courses', new admin_externalpage('coursemgmt_category', get_string('coursemgmt_category', 'admin'), $CFG->wwwroot . '/course/index.php?categoryedit=on',
		array('moodle/category:manage', 'moodle/course:create')));
			
	$ADMIN->add('courses', new admin_externalpage('coursemgmt', get_string('coursemgmt', 'admin'), $CFG->wwwroot . '/course/category.php?id=1&categoryedit=on',
		array('moodle/category:manage', 'moodle/course:create')));

	$ADMIN->add('courses', new admin_externalpage('coursemgmt_exam', get_string('coursemgmt_exam', 'admin'), $CFG->wwwroot . '/course/category_3.php?id=3&categoryedit=on',
		array('moodle/category:manage', 'moodle/course:create')));			

/// Course Default Settings Page
/// NOTE: these settings must be applied after all other settings because they depend on them
    ///main course settings
    $temp = new admin_settingpage('coursesettings', get_string('coursesettings2'));
