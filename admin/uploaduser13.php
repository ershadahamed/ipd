    ...
    while ($line = $cir->next()) {
        ...
        if ($existinguser) {
            ...
            if ($user->password === hash_internal_user_password($defaultpassword)) {
                ...
                // set_user_preference('auth_forcepasswordchange', 1, $user);  // add by arizan
            }
    ...
    if ($DB->count_records('user_preferences', array('name' => 'create_password', 'value' => '1'))) {
        ...
        foreach ($newusers as $newuser) {
            ...
            foreach(get_autoenrol() as $cid){
                ...
                $finaltestid = '64';
                get_accesstoken($newuser->id, $finaltestid); // create token id for final test // by arizan abdullah
