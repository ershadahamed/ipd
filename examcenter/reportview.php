...
if ($viewreport['selectedreport'] == '0') {
    ...
    <div style="overflow-x:scroll;width:100%;">
        <fieldset style="padding: 1em;" id="user" class="clearfix">
            ...
            <form name="form1" id="form1" action="<?= $CFG->wwwroot . '/examcenter/download_reportcsv.php?rid=' . $reportid . '&csv=csv&excel=excel&html=html&sid=' . $_GET['sid']; ?>" method="post">
                ...
                <table style="float:left;padding:0px; border: 0px solid #666666; border-collapse:collapse;margin:0px auto;" width="78%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td align="left">
                            <!--b>DOWNLOAD</b-->
                            <input type="submit" name="download_html" id="id_defaultbutton" value="HTML" title="<?= get_string('titledownload'); ?>" onClick="this.form.action = '<?= $CFG->wwwroot . '/examcenter/download_reporthtml.php?rid=' . $reportid . '&rcid=' . $viewreport['reportcreator'] . '&sid=' . $_GET['sid']; ?>', target = '_blank'" />
	...
	";
              ...
              $csql = "SELECT *, c.id as enrollmentid, c.lastaccess as courselastaccess FROM {$statement}";
                $sqlquery = mysql_query($csql);
                ?>	<!--div style="overflow-x:scroll;width:100%;"-->
                <table border="1" id="searchtable" style="margin:0px auto;">
                    <tr style="background-color:#ccc;">
                        <?php if (($creator['id'] == '12') || ($creator['id'] == '13')) { ?>
                            ...
                            <?php }if ($viewreport['department'] != '0') { ?>
                                ...
                                echo '<th width="20%">' . get_string('enrolstatus') . '</th>';
                            }
	...
	";
                            ...
                            <tr>		  
                                <?php if (($creator['id'] == '12') || ($creator['id'] == '13')) { ?>
                                    ...
                                    <?php }if ($viewreport['department'] != '0') { ?>
                                        ...
                                        // ENROL STATUS HERE!!!!
                                        echo '<td style="text-align:center" scope="row">';
                                        echo checkuserstatus($sqlrow['userid']);
                                        echo '</td>';
                                    }
                                } else if (($creator['id'] == '10')) {
                                    ?>
                         ...
                         ";
                                        ...
                                        echo $a . ' of ' . getTotalScormOnCourse($sqlcourse['id']) . ' Modules';
                                        ?>
                                    </td>
                                <?php } if ($viewreport['totaltimeperformance'] != '0') { ?>
                                    <td style="text-align:center;">
                                ...
                                <?php } if ($viewreport['lastaccess'] != '0') { ?>
                                    <td style="text-align:center;">
                                        <?php
                                        if ($sqlrow['firstaccess'] != 0) {
                                            if ($sqlrow['courselastaccess'] != 0) {
                                                echo date('d-m-Y H:i:s', $sqlrow['courselastaccess']);
                                            } else {
                                                echo ' - ';
                                            }
                                        } else {
        ...
        <form name="form2" id="form2" action="<?= $CFG->wwwroot . '/examcenter/download_reportcsv.php?rid=' . $reportid . '&csv=csv&excel=excel&html=html&sid=' . $_GET['sid']; ?>" method="post">
            ...
            <table style="padding:0px; border: 0px solid #666666; border-collapse:collapse;margin:0px auto;" width="95%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td align="left">
                        <!--b>DOWNLOAD</b-->
                        <input type="submit" name="download_html_2" id="id_defaultbutton" value="HTML" title="<?= get_string('titledownload'); ?>" onClick="this.form.action = '<?= $CFG->wwwroot . '/examcenter/download_reporthtml.php?rid=' . $reportid . '&sid=' . $_GET['sid']; ?>', target = '_blank'" />
                        ...
                        <input type="button" name="download_csv_" id="id_defaultbutton" value="CSV" title="<?= get_string('titledownload'); ?>" onclick="checkfield()" />
                    </td>
                    <td align="right"><input type="submit" name="buttonback2" id="id_defaultbutton" onclick="this.form.action = '<?= $CFG->wwwroot . '/examcenter/myreport.php?id=' . $USER->id; ?>'" value="<?= get_string('back'); ?>" />
                        <input type="submit" name="buttonprint2" id="id_defaultbutton" value="Print" onClick="this.form.action = '<?= $CFG->wwwroot . '/examcenter/reportview_print.php?id=' . $_GET['id']; ?>', target = '_blank'" />
...
<?php } else { ?>
	...
	";
            ...
            echo $csql = "SELECT *, c.id as enrollmentid, a.idnumber as coursecode FROM {$statement}";
            $sqlquery = mysql_query($csql);
            ?>	
	...
	");
				...
				");
                            ...
                            <?php } if ($viewreport['totaltime_statistics'] != '0') { ?>
                                <td style="text-align:center;"><?= $totaltimeaccess; ?></td>
            <?php } ?>
