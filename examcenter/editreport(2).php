...
<form name="form2" id="form2" action="" method="post">
	...
	<table style="padding:0px; border: 0px solid #666666; border-collapse:collapse;margin:0px auto;" width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr>
			...
			<td align="right">
				<input type="submit" name="confirmindividual" id="confirmindividual" value="Confirm" onClick="this.form.action='<?=$CFG->wwwroot. '/examcenter/reportmenu_org_action_update.php?id='.$USER->id.'&sreport='.$selectreport.'&nreport='.$reportname;?>'" />         
