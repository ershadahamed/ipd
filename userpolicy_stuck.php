...
<?php
	...
	if($paymethod == 'paypal'){
		$link=$CFG->wwwroot. '/portal/subscribe/subscribedetails_stuck.php?invoice='.$invoice.'&&paymethod=paypal&&traineeID='.$traineeID.'&&trainee_name='.$firstname.'&&lastname='.$lastname.'&&address='.$address.'&&address2='.$address2.'&&email='.$email.'&&phone='.$phone.'&&city='.$city.'&&province='.$province.'&&postal='.$postal.'&&country='.$country.'&&cost='.$cost.'&&currency='.$currency.'&&PaypalBusinessEmail='.$PaypalBusinessEmail.'&&coursename='.$coursename.'&&shortname='.$shortname.'&&courseid='.$courseid; 
	}else if($paymethod == 'creditcard'){
		$link2=$CFG->wwwroot. '/portal/subscribe/subscribedetails_stuck?invoice='.$invoice.'&&paymethod=creditcard&&traineeID='.$traineeID.'&&trainee_name='.$firstname.'&&lastname='.$lastname.'&&address='.$address.'&&address2='.$address2.'&&email='.$email.'&&phone='.$phone.'&&city='.$city.'&&province='.$province.'&&postal='.$postal.'&&country='.$country.'&&cost='.$cost.'&&currency='.$currency.'&&PaypalBusinessEmail='.$PaypalBusinessEmail.'&&coursename='.$coursename.'&&shortname='.$shortname.'&&courseid='.$courseid; 
	}else{
		$link3=$CFG->wwwroot. '/portal/subscribe/subscribedetails_stuck.php?invoice='.$invoice.'&&paymethod=telegraphic&&traineeID='.$traineeID.'&&trainee_name='.$firstname.'&&lastname='.$lastname.'&&address='.$address.'&&address2='.$address2.'&&email='.$email.'&&phone='.$phone.'&&city='.$city.'&&province='.$province.'&&postal='.$postal.'&&country='.$country.'&&cost='.$cost.'&&currency='.$currency.'&&PaypalBusinessEmail='.$PaypalBusinessEmail.'&&coursename='.$coursename.'&&shortname='.$shortname.'&&courseid='.$courseid; 	
	}
?>
