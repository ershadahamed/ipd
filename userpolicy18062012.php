...
<tr valign="top"><td><input type="button" name="proceddnext" value=" Next >> " onclick="checkfield()"/>
<input type="button" name="proceddnext2" value=" Next2 >> " onclick="post_to_url()"/></td></tr>
</table>
</td></tr></table>
</form>
