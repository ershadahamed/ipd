...
?>	
<div style="width:100%;">	
<table style="width: 100%; <?php if($USER->id !='2'){ ?> min-width: 1166px;<?php }else{ ?> min-width: 937px; <?php } ?> float:left; padding:0px; margin:0px;" align="center" border="0" cellpadding="0" cellspacing="0">
	<tr><td colspan="2">
	<?php 	
		if(($USER->id)!='2'){
			...
			}else if($qrole->roleid =='12'){	//Business partner 
				include('userfrontpage/hradmin_home_page.php');
			}else if($qrole->roleid =='13'){	//Hr Admin//Instituion Client 
				include('userfrontpage/hradmin_home_page.php');
			}else if($qrole->roleid =='14'){	//Inactive HR admin - Inactive Institutional Client
				include('userfrontpage/inactivehradmin_home_page.php');
			}else if($qrole->roleid =='18'){	//Inactive Business Partner
				include('userfrontpage/inactiveBP_home_page.php');
			}else if($qrole->roleid =='19'){	//Inactive Exam Center
				include('userfrontpage/inactiveEC_home_page.php');
			}else{
				//if users //index//home
				unset($_SESSION['cart']);
