...
$transaction_content="
														...
														<li>Paypal name: $firstname $lastname</li>
														<li>Item: $itemname</li>
														<li>Amount: $amount</li>
														<li>Payment_status: $payment_status</li>
														<li>Mc_currency: $mc_currency</li>
														<li>Payer_email: $payer_email</li>
														<li>Txn_id: $txn_id</li>		
															
														<li>invoice: $invoice</li>
														<li>business: $business</li>
														<li>receiver_email: $receiver_email</li>
														<li>receiver_id: $receiver_id</li>
														<li>memo: $memo</li>
														<li>option_name1: $option_name1</li>
														<li>option_name2: $option_name2</li>
														<li>option_selection1: $option_selection1</li>
														<li>option_selection2: $option_selection2</li>
														<li>tax: $tax</li>	
														<li>payment_type: $payment_type</li>
														<br/>
														";	
