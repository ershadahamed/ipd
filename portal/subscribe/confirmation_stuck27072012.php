<?php
	...
	$sqlse=mysql_query("SELECT * FROM mdl_cifa_modulesubscribe WHERE traineeid='".$USER->traineeid."' AND payment_status='New' AND courseid='".$id."'");
