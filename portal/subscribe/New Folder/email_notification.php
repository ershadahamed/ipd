...
$replyemail="arizan_86@yahoo.com"; //change to your email address
$valid_ref1="http://localhost/cifa/paymentdetails.php"; //change to your domain name
$valid_ref2="http://localhost/cifa/paymentdetails.php"; //change to your domain name

// -------- No changes required below here -------------------------------------------------------------
//
// email variable not set - load $valid_ref1 page
if (!isset($_POST['email'])) //change to trainee email
{
...
if((!$valid_referrer) OR ($_POST["block_spam_bots"]!=12)) //you can change this but remember to change it in the contact form too
{
 ...
 if (file_exists("debug.flag")) echo '<hr>"$valid_ref1" and "$valid_ref2" are incorrect within the file:<br>
                                      email_notification.php <br><br>On your system these should be set to: <blockquote>
                                                                          $valid_ref1="'.str_replace("www.","",$ref_page).'"; <br>
                                                                          $valid_ref2="'.$ref_page.'";
                                                                          </blockquote></h2>Copy and paste the two lines above
                                                                          into the file: email_notification.php <br> (replacing the existing variables and settings)';
 exit;
}
...
$name = $_POST['traineename']; //trainee name
$email = $_POST['email']; //trainee email

$thesubject = 'Online purchasing module';
$themessage = 'Thank u for purchasing our fullpackage module....';
...
$success_sent_msg='<p align="center"><strong>&nbsp;</strong></p>
                   ...
                   <p align="center">A copy of your details purchasing has been sent to you.</p>
                   <p align="center">Thank you for your subsciber.</p>';

$replymessage = "Hi $name

Thank you for your subsciber.
