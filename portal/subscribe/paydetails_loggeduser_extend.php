...
$PAGE->navbar->add($buy_cifa)->add($selectprogram)->add($your_details);
...
<!--**********************FORM AREA****************************************************************-->
    ...
    <form id="fullpackinfo" name="fullpackinfo" action="confirmation_loggeduser.php?extendid=3" method="post" onSubmit="return valCari(this);">
        <?php } else if ($_GET['resitexamid'] == '4') { ?>
        <form id="fullpackinfo" name="fullpackinfo" action="confirmation_loggeduser.php?extendid=4&resitid=<?= $_GET['resitid']; ?>" method="post" onSubmit="return valCari(this);">
            <?php } else { ?>
...
<?php } ?>
		...
		");
                                ...
                                <tr bgcolor="#FFFFFF">			
                                    ...
                                    <td class="adjacent" style="text-align:left;"><?php if ($_GET['resitexamid'] == '4') {
                                    echo $examname;
                                } else {
                                    echo $pname;
                                } ?>&nbsp;
...
<?php if ($DOB->gender == '0') {
    ...
    echo 'Female';
                    ...
                    <tr>
                        <td><?= get_string('zip'); ?></td><td width="1%">:</td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            while ($kn = mysql_fetch_array($kodnegeri)) {
                                echo "<option value='" . $kn['Negeri'] . "'";
                                if ($DOB->state == $kn['Negeri']) {
                                    echo "selected='selected'";
                                }
                                echo ">";
                                echo $kn['Negeri'] . "</option>";
                            }
                            ?>
                            </select>
                            <?php //}else{ echo $DOB->state; } ?>
                        </td>
                    </tr>	
...
?>
                <table style="width:100%;margin:0 auto;font: 13px/1.231 arial,helvetica,clean,sans-serif;"><tr><td>
                            ...
                            <table style="width:95%;margin:0 auto;font: 13px/1.231 arial,helvetica,clean,sans-serif;">
                                        ...
                                        <tr valign="top">
                                            <td>
                                                <input type="checkbox" name="column<?= $count++; ?>" id="column<?= $count2++; ?>" value="1" checked <?php if (($bil == '1') || ($bil == '3')) {
    ...
    <?php }
            ...
            <p align="center">
<?php if (($_GET['resitexamid'] == '3') || $_GET['resitexamid'] == '4') { ?>
                    <input id="id_defaultbutton" type="submit" name="backbutton" onclick="this.form.action = '<?= $CFG->wwwroot . '/coursesindex.php?id=' . $USER->id; ?>'" title="back to My training" value=" Back " />
<?php } else { ?>
