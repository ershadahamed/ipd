		  ...
		  <tr style="background-color:#fff; border-color:#cccccc;" valign="top">
			<td width="50%">
				<?php
					...
					$isocountry="+".$qco['iso_countrycode']."-";
				?>
...
<div style="text-align:center;" id="confirmationenrollbuttons">
			...
			<input type="submit" title="<?=get_string('ipdonline');?>" onClick="this.form.action='<?=$cifaworkspace;?>'" value="<?=get_string('ipdonline');?>.com" name="<?=get_string('ipdonline');?>" />
</div><br/>
