...
<!---user policy popup---->
    ...
    <div id="examples">
	  <a href="<?php echo $CFG->wwwroot. '/userpolicy.php'; ?>" class="tu_iframe_1000x600">User policy</a>
    </div>
    <script type="text/javascript">
      TopUp.addPresets({
        "#examples a": {
          title: "SHAPETM Online Training Program User Policies – Please Read Before Purchasing",
          group: "examples",
          readAltText: 1,
          shaded: 1
        }
