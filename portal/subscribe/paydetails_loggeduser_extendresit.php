...
<div style="margin:0px auto; width:95%; padding-top:20px;">
	...
	<?php
		...
		?>
				...
				?>
				<td class="adjacent" style="text-align:center;">$ 50</td>
				<td class="adjacent" style="text-align:center;">$ <?php echo (50*$q);?></td>
				<?php
					}else{
				?>
		...
		?>
			<tr style="height:30px;">
                ...
                <td class="adjacent" style="text-align:center;"><b>$ 50</b></td>
				<?php }else{ ?>
