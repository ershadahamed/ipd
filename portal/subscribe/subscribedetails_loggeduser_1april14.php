...
window.open(printtxt);
	...
	function onUserInactivity() {
	   ...
	   <?php //session_destroy(); ?>
	   alert('You has been idle for 15 minutes. System will logout automatically.');
	}
	</script>
<!--- step by step----->
<style>
...
<table id="availablecourse3"  width="99%" border="1" style="bgcolor:#FFFFFF; border-collapse: collapse; border-spacing: 0; border-color:#cccccc;margin: 0px auto;">
	<tr style="background-color:#5dcbec;"><td colspan="3"><h3>Please pay to SHAPE for Economic Consulting W.L.L  at Boubyan Bank</h3></td></tr>	
	...
	<tr><td colspan="3"><?php $a = new stdClass(); $a='<a href="#" style="text-decoration:underline" target="_blank">contact@learncifa.com</a>'; ?><?=get_string('textpayment', '', $a);?></td></tr>
...
<table width="100%" border="0" style="bgcolor:#FFFFFF; border-collapse: collapse; border-spacing: 0; border-color:#cccccc;margin: 0px auto;">  
	<tr>
		...
		<table id="availablecourse3" style="bgcolor:#FFFFFF; border-collapse: collapse; border-spacing: 0; border-color:#cccccc;margin: 0px auto;" width="100%" border="1">
		  <tr style="background-color:#5dcbec;">
...
<div style="text-align:center;">
			...
			<input type="submit" title="<?=get_string('learncifa');?>" onClick="this.form.action='<?=$learncifacom;?>'" value="<?=get_string('learncifa');?>" name="learncifa" />
</div><br/>
