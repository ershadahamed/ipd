<?php
	...
	function definition() {
		...
		$mform->addElement('editor','financialsummary_editor', get_string('content'), null, $editoroptions);
        $mform->addHelpButton('financialsummary_editor', 'content');
		$mform->addRule('financialsummary_editor', get_string('content').' Required', 'required', null, 'client');
        $mform->setType('financialsummary_editor', PARAM_RAW);		
