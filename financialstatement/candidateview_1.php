    ...
    <tr style="background-color:#21409A; color:#FFFFFF;">
      <th style="width:20%; padding:0px;">Date
        <?php /*<div style="position: relative;">
            <img src="../image/btp_b.png" style="background: transparent;width:100%; height:2.5em; border: 0; padding: 0" />
            <!-- Put the upper left corner of the character in the middle then move it (left+up)wards by "half" of the char width -->
            <span style="position: absolute; top: 50%; margin-top: -0.6em; margin-left: 0.5em; text-align:center;">Date</span>
        </div> */ ?>     
      </th>
      <th style="padding-left:5px;">Description
        <?php /*<div style="position: relative;">
            <img src="../image/btp_b.png" style="width:100%; height:2.5em; border: 0; padding: 0" />
            <!-- Put the upper left corner of the character in the middle then move it (left+up)wards by "half" of the char width -->
            <span style="position: absolute; top: 50%; margin-top: -0.6em; margin-left: 0.5em; text-align:center;">Description</span>
        </div>      */?>
      </th>
      <th style="width:15%;padding:0px;">Debit (USD)
        <?php /*<div style="position: relative;">
            <img src="../image/btp_b.png" style="width:100%; height:2.5em; border: 0; padding: 0" />
            <!-- Put the upper left corner of the character in the middle then move it (left+up)wards by "half" of the char width -->
            <span style="position: absolute; top: 50%; margin-top: -0.6em; margin-left: 0.5em; text-align:center;">Debit (USD)</span>
        </div>    */?>  
      </th>
      <th style="width:15%;padding:0px;">Credit (USD)
        <?php /*<div style="position: relative;">
            <img src="../image/btp_b.png" style="width:100%; height:2.5em; border: 0; padding: 0" />
            <!-- Put the upper left corner of the character in the middle then move it (left+up)wards by "half" of the char width -->
            <span style="position: absolute; top: 50%; margin-top: -0.6em; margin-left: 0.5em; text-align:center;">Credit (USD)</span>
        </div> */?>      
      </th>
    </tr><?php }else{ ?>
