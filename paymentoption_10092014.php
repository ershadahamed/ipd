	...
	if (isloggedin()) {
		header("location:index.php");
			...
			$userprogram=mysql_query("INSERT INTO mdl_cifauser_program SET userid='".$userow['id']."', programid='".$progrow['id']."', programname='".$programname."'");	
									...
									// email to commenter
									$to = $email;
									$subject = "Next Step: CANDIDATE ID - Candidate Part-Enrolment Confirmation";
									...
									$message = "
										...
										<p>Candidate ID: ".$traineeID."</p>
										
										<p style='text-align:justify;'>
										I am pleased to congratulate you to have taken the first step in enrolling as SHAPE&reg; IPD Candidate. Your Candidate ID is <strong>".$traineeID."</strong> . Please quote this in all future correspondence with us. 
										</p>
											
										<p style='text-align:justify;'>
										The next step is to wire transfer the relevant payment to us within the stipulated 4 weeks to ensure your successful enrolment as a SHAPE&reg; IPD Candidate. Failing to meet the deadline, your enrolment will be cancelled. </p>
										...
										<p style='text-align:justify;'>You will be liable  for the additional charges incurred in the bank transfer. Please be sure to  send the successful bank transfer slip with your Candidate ID to <strong><u>contact us</u></strong>. The process to verify  payment and updating your status may take up to 7 days. </p>										
