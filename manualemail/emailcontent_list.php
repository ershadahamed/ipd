<?php
    ...
    $emailcontentconfig = get_string('emailcontentconfig');
    $PAGE->navbar->add(ucwords(strtolower($emailcontentconfig)));	
...
var f=document.form;
  ...
  reason += validateFirstname(theForm.emailcontent_for);
...
<legend style="font-weight:bolder;" class="ftoggler"><?=$emailcontentconfig;?></legend>
<table width="100%" border="0">
  <tr>
    <td width="20%">Content For</td>
    <td width="1%"><strong>:</strong></td>
    <td><input name="emailcontent_for" type="text" id="emailcontent_for" style="width:100%" onKeyUp="javascript:this.value=this.value.toTitleCase()" /></td>
  </tr>
  <tr>
