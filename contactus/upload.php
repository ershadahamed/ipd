<?php
	...
	if(isset($_FILES["myfile"]))
	{
		...
		$toadmin = $supportemail;
		$subjectadmin = $subjectcontent;
		$messageadmin = $messageto;
		...
		/////// AUTHMAIL ///////////////////////////////////////////////////////////////////////
		$fromuser=$email;  
		$namefromuser="IPD Online";
		$nametoadmin = "IPD Online"; 
				
		// this is it, lets send that email!
		authgMail($fromuser, $namefromuser, $toadmin, $nametoadmin, $subjectadmin, $messageadmin);		
		// End email to Administrator // info@consultshape.com
...
<?php				
	...
	if($_FILES["myfile"]==''){ //only contact us details without upload files
		...
		$nametocommentar = "IPD Online"; 
				
		// this is it, lets send that email!
		authgMail($fromadmin, $namefromadmin, $to, $nametocommentar, $subject, $message);		
