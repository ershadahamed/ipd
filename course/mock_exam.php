	...
	a:hover {text-decoration:underline;}
        ...
        <table id="availablecourse" style="margin-bottom:1em;">
			...
			{				
				...
				$link_to_mock=$CFG->wwwroot.'/mod/quiz/view.php?id='.$m_rws['id1'];
				$m_link_open="<a href='".$link_to_mock."' title='Click to start ".$m_rws['name1']."'>";
				$link_close="</a>"; ?>
                <tr>
                    <td class="adjacent" align="center"><?=$bil++;?></td>
                    <td class="adjacent" style="text-align:left;"><?=$m_rws['name1'];?></td>
