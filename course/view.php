...
//  Display the course home page.
   ...
   //add by arizan
   $queryrole  = $DB->get_records('role_assignments',array('userid'=>$USER->id, 'contextid'=>'1'));
   ...
   $PAGE->set_heading($site->fullname);
	...
	$urlcourse = new moodle_url('/coursesindex.php', array('course'=>$course->id)); //added by arizan
	$urlcourse2 = new moodle_url('/course/view.php', array('id'=>$course->id)); //added by arizan
	//$urleditpicture = new moodle_url('/user/edit_picture.php', array('id'=>$USER->id, 'course'=>$course->id));
	$PAGE->navbar->add(get_string('mytraining'), $urlcourse)->add(get_string('activetrainings'), $urlcourse)->add($course->fullname , $urlcourse2);  // arizan abdullah 
