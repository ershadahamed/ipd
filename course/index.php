...
admin_externalpage_setup('coursemgmt_category');
...
// if (has_capability('moodle/course:create', $systemcontext)) {
    ...
    // echo $OUTPUT->single_button(new moodle_url('edit.php', $options), get_string('addnewcourse').' modules', 'get');
// }
...
/// Recursive function to print all the categories ready for editing
    ...
    if (!empty($category)) {
		...
		if($category->id != '6'){ //add by arizan abdullah on 25042012
