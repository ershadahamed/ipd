...
$courseenrolid = get_coursesenrolid($course->id);
// update timemodified for last access to the course// not admin
if ($USER->id != '2') {
    $updatesql = mysql_query("UPDATE {$CFG->prefix}user_enrolments 
                SET lastaccess='" . time() . "'  WHERE status='0' AND enrolid='" . $courseenrolid . "' AND userid='" . $USER->id . "'
                ");
}
...
echo '<div style="display:none">' . $completioninfo->display_help_icon() . '</div>';
if ($rs['roleid'] == '3') {
...
//header
    $spacewhite = '<div style="padding-bottom:0.9em;"></div>';
    echo $spacewhite . '<table border="0" width="100%" style="margin:0px;"><tr>';
    echo '<td width="80%" style="color:#fff;background-color:#21409A;border: 1px solid #E5E5E5;"> <b>';
    ...
    echo '</b> </td>';
    echo '<td width="20%" style="color:#fff;background-color:#21409A;text-align:center;border: 1px solid #E5E5E5;"> <b>Progress</b> </td></tr>';
//header
/// Print Section 0 with general activities
    $section = 0;
    $thissection = $sections[$section];
...
//if($USER->id == '2'){
    if ($thissection->summary or $thissection->sequence or $PAGE->user_is_editing()) {
        ...
        if ($rs['roleid'] != '10') {
            ...
            echo '<li style="border: none;margin:0px;" id="section-0" class="section main clearfix" >';
        } else {
            echo '<li id="section-0" class="section main clearfix" >';
        }
        echo '<div class="left side">&nbsp;</div>';
        ...
        if ($rs['roleid'] != '10') {
            ...
            echo '<div class="content" style="float:left;">';
            echo '<div class="mod-indent">';
            print_section_completion($course, $thissection, $mods, $modnamesused);
            echo '</div>';
            echo '</div>';
            echo '</td>';
            echo "</tr>";
