...
echo $spacewhite.'<table border="0" width="100%" style="margin:0px;">';
echo '<td width="80%" style="color:#fff;background-color:#5DCBEB;border: 1px solid #E5E5E5;"> <b>';
...
echo '</b> </td>';
echo '<td width="20%" style="color:#fff;background-color:#5DCBEB;text-align:center;border: 1px solid #E5E5E5;"> <b>Progress</b> </td>';	
while ($section <= $course->numsections) {
    ...
    if ($showsection) {
        ...
        /*if ($displaysection == $section) {    // Show the zoom boxes //hidden by arizan abdullah
            echo '<a href="view.php?id='.$course->id.'&amp;topic=0#section-'.$section.'" title="'.$strshowalltopics.'">'.
                 '<img src="'.$OUTPUT->pix_url('i/all') . '" class="icon" alt="'.$strshowalltopics.'" /></a><br />';
        } else {
            $strshowonlytopic = get_string("showonlytopic", "", $section);
