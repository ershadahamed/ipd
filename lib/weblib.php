...
function print_password_policy() {
    ...
    if (!empty($CFG->passwordpolicy)) {
		...
		//$message .= get_string('informminpasswordlength', 'auth').', '.get_string('informminpasswordupper', 'auth').', '.get_string('informminpasswordlower', 'auth').' '.get_string('informminpassworddigits', 'auth');
