...
EOS;
	...
	//added by arizan
    function add_action_buttons2($cancel = null, $submitlabel=null){
        if (is_null($submitlabel)){
            $submitlabel = get_string('savechanges');
        }
        $mform =& $this->_form;
    ...
    */
    function renderHeader(&$header) {
        ...
        if (isset($this->_advancedElements[$name])){
            ...
            //$button = '<input name="'.$elementName.'" class="showadvancedbtn" value="'.$buttonlabel.'" type="submit" />'; //modi by arizan
