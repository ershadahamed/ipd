...
//echo date('dmY',strtotime('120 days'));
    ...
    while ($rs1 = mysql_fetch_array($sql1)) {
        $qry2 = "SELECT a.status, a.enrolid, b.firstaccess,b.lastaccess,b.firstname, b.lastname, b.traineeid,a.userid,a.timestart,a.timeend,b.lastlogin, a.lastaccess as courselastaccess,
