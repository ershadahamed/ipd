    ...
    var gui_ajax = {
        ...
        init : function(cfg) {
            ...
            this.layout = new YAHOO.widget.Layout({
                units : [
                     {position: 'right', width: 200, resize: true, gutter: '5px', scroll: true, body: 'chat-userlist', animate: false},
                     {position: 'bottom', height: 85, resize: true, body: 'chat-input-area', gutter: '5px', collapse: false, resize: false},
