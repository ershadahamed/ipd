...
$theme   = optional_param('theme', 'bubble', PARAM_SAFEDIR);
...
$table->data = array(
    array('<div style="height: 10em;">Start Chatting Now <br/> &raquo; <input type="text" disabled="true" id="input-message" value="Loading..." size="50" /> <input type="button" id="button-send" value="'.get_string('send', 'chat').'" /></div><br/>')
);
