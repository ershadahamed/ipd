...
$string['addingquestions'] = 'This side of the page is where you manage your database of questions.  Questions are stored in categories to help you keep them organised, and can be used by any quiz in your module or even other modules if you choose to \'publish\' them. <br /><br />After you select or create a question category you will be able to create or edit questions.  You can select any of these questions to add to your quiz over on the other side of this page.';
...
$string['backtocourse'] = 'Back to the module';
...
/*$string['confirmclose'] = 'Once you click finish, you will no longer be able to change your answers for this attempt.';*/
// $string['confirmclose'] = 'Once you click Finish, you will not be able to return to the test.';
$string['confirmclose'] = 'Once you click Finish, you will not be able to return to the examination.';
...
$string['confirmstartattempttimelimit'] = 'This test has a time limit and is limited to {$a} attempt(s). You are about to start the test.  Do you wish to proceed?';
// $string['confirmstarttimelimit'] = 'The test has a time limit. Are you sure that you wish to start?';
$string['confirmstarttimelimit'] = 'The test has a time limit. Are you sure that you wish to start?';
...
$string['coursetestmanager'] = 'Module Test Manager format';
...
$string['downloadextra'] = '(file is also stored in the module files in the /backupdata/quiz folder)';
...
$string['groupsnone'] = 'There are no groups in this module';
...
$string['importcategory'] = 'import curriculum';
$string['importerror'] = 'An error occurred during import processing';
$string['importfilearea'] = 'Import from file already in module files...';
...
$string['invalidcategory'] = 'Curriculum ID is invalid';
...
$string['nocategory'] = 'Incorrect or no curriculum specified';
...
$string['noquestionsnotinuse'] = 'This random question is not in use, since its curriculum is empty.';
...
$string['notenoughrandomquestions'] = 'There are not enough questions in curriculum {$a->category} to create the question {$a->name} ({$a->id}).';
...
$string['publishedit'] = 'You must have permission in the publishing module to add or edit questions in this curriculum';
$string['qname'] = 'name';
$string['qbrief'] = 'Q. {$a}';
...
$string['quiznavigation'] = 'Navigation';
...
$string['quiztimelimit'] = 'Duration: {$a}';
...
$string['savedfromdeletedcourse'] = 'Saved from deleted module "{$a}"';
...
$string['submitallandfinish'] = 'Finish';
...
$string['summaryofattempt'] = 'Script Summary';
...
$string['unusedcategorydeleted'] = 'This category has been deleted because, after deleting the module, its questions weren\'t used any more.';
...
$string['url'] = 'URL';
$string['usedcategorymoved'] = 'This category has been preserved and moved to the site level because it is a published category still in use by other modules.';
...
$string['youneedtoenrol'] = 'You need to enrol in this module before you can attempt this quiz';
$string['yourfinalgradeis'] = 'Your final grade for this quiz is {$a}.';

$string['testinstructions']='
	<div style="text-align:justify;"><ul><li>
	This test consist of 20 Multiple Choice Questions (MCQ) with a time limit of 30 minutes. Once the time elapses, the test will terminate immediately.</li><br/>
	<li>
	The test must be completed within one session.  It cannot be resumed later. <br/>
	<br/>
	</li><li>
	You are entitled to 2 attempts. Your test result will be based on the latest attempt. Therefore your 2nd attempt result will override the 1st attempt result. <br/>
	<br/>
	</li>
	<li>The clock will start once you click the &quot;<strong>Start Now</strong>&quot; button. You will not be able to pause during the test.<br/><br/>
	</li><li>Click the &quot;<strong>Next</strong>&quot; button to submit your answer. Answers will not be saved if you do not click the &quot;<strong>Next</strong>&quot; button.<br/>
	<br/>
	</li>
	<li>
	You may return to any question(s) to change the answer. Use the &quot;<strong>Status</strong>&quot; button to check your answers and navigate through the test <br/>
	<br/>
	</li>
	<li>To end the test, click &quot;<strong>Finish</strong>&quot;. Ensure you have answered all the questions. Click the  &quot;<strong>Finish</strong>&quot; button again and  &quot;<strong>Confirm</strong>&quot; to end the test.<br/>
	<br/>
	</li>
	<li>
	You will know your performance from the  &quot;<strong>Result Summary</strong>&quot; page, which you may print and save. <br/>
	<br/>
	</li>
	<li>The passing mark is 60%. Upon successful completion , user will be entitled to <strong>Certificate of Completion</strong><br/>
	<br/>
	</li>
	<li>
	When you are ready <strong>[to start]</strong>, click &quot;<strong>Proceed</strong>&quot; and &quot;<strong>Start Now</strong>&quot;.<br/>
	<br/>
	</li>
	</div>
';
$string['testinstructionsadib']='
	<div style="text-align:justify;"><ul><li>
	This test consist of 20 Multiple Choice Questions (MCQ) with a time limit of 30 minutes. Once the time elapses, the test will terminate immediately.</li><br/>
	<li>
	The test must be completed within one session.  It cannot be resumed later. <br/>
	...
	<li>The passing mark is 75%. Upon successful completion , user will be entitled to <strong>Certificate of Completion</strong><br/>
	<br/>
	</li>
	<li>
	When you are ready <strong>[to start]</strong>, click &quot;<strong>Proceed</strong>&quot; and &quot;<strong>Start Now</strong>&quot;.<br/>
...
$string['examinstructions']='
	<ul><li>
	  The CIFA&#8482; Foundation Examination has:
	...
	<li>
	  The examination  clock will start once you click the &quot;<strong>Start Now</strong>&quot;  button. You will not be able to pause during the examination. <br/>
	  <br/>
	</li>
	<li>
	Click the &quot;<strong>Next</strong>&quot; button to submit your answer. Answers will not be saved if you do not click the &quot;<strong>Next</strong>&quot; button. <br/>
	<br/>
	</li><li>
	You may return to any question(s) to change the answer. Use the &quot;<strong>Status</strong>&quot;  button to check your answers and navigate through the examination.<br/>
	<br/>
	</li>
	<li>
	To end the examination, click &quot;<strong>Finish</strong>&quot;. Ensure you have answered all the questions. Click the &quot;<strong>Finish</strong>&quot; button again, and  &quot;<strong>confirm</strong>&quot; to end the examination. <strong><u></u></strong><br/>
	<br/>
	</li><li>
	You will know your performance from the  &quot;<strong>Result  Summary</strong>&quot;page, which you may print and save.<br/><br/>
	</li>
	<li>
	When you are  ready <strong>[to start]</strong>, click &quot;<strong>Proceed&quot; </strong>then &quot;<strong>Start Now</strong>&quot;.</li></ul>
';

$string['mockexaminstructions']='
	<ul style="text-align:justify;"><li>
	  The {$a} has:
	  <ul style="list-style-type:circle;">
		<li>5 MCQ Questions</li>
		<li>Duration: 7 Minutes 30 Seconds</li>
	  </ul>
	  
	</li>
	<li>
	  The test  clock will start once you click the &quot;<strong>Start Now</strong>&quot;  button. You will not be able to pause during the test. <br/>
	  <br/>
	</li>
	<li>
	Click the &quot;<strong>Next</strong>&quot; button to submit your answer. Answers will not be saved if you do not click the &quot;<strong>Next</strong>&quot; button. <br/>
	...
	<li>
	To end the test, click &quot;<strong>Finish</strong>&quot;. Ensure you have answered all the questions. Click the &quot;<strong>Finish</strong>&quot; button again, and  &quot;<strong>confirm</strong>&quot; to end the examination. <strong><u></u></strong><br/>
	<br/>
	</li><li>
	You will know your performance from the  &quot;<strong>Result  Summary</strong>&quot;page, which you may print and save.<br/><br/>
	</li>
...
$string['printresults']='Print result';
$string['quiz_result_summary']='SHAPE<sup>&reg;</sup> IPD Final Test';
$string['quiz_result_summary_mock']='SHAPE<sup>&reg;</sup> IPD Mock Test';
$string['examination_grades']='CIFA<sup><font size="1px">TM</font></sup> Examination Grades';
$string['correctanswer']='Correct Answer';
$string['resultpercent']='Result (%)';
$string['totalquestion']='Total';
$string['resultsection']='Section';
$string['finish'] = 'Finish';
$string['printresults']='Print Summary';
$string['quizname_set']='SHAPE<sup>&reg;</sup> IPD Final Test';
$string['quizname_summary']='Test Summary';
$string['quizname_summary_mock']='Mock Test Summary';
$string['moduletest_name']='Foundations in Islamic Banking & Finance ';
