...
$transaction->allow_commit();
//redirect($attemptobj->review_url()); arizanabdullah 15FEB2013
//if($attemptobj->get_courseid() == '12'){
	if($USER->id != '2'){
		redirect($CFG->wwwroot .'/mod/quiz/result-summay.php?attemptid='.$attemptobj->get_attemptid().'&examid='.$attemptobj->get_quizid().'&courseid='.$COURSE->id.'&seskey='.sesskey());
	}else{
