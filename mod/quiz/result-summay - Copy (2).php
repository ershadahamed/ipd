...
<div id="welcometable"><h1><?php echo $resultsummary; ?></h1></div>	
		...
		<table id="availablecourse">
			...
			<tr>
				...
				Where
				  a.userid = '".$q['id']."'
					...
					//while($quetotal=mysql_fetch_array($squery)){ echo $quetotal['questionid'].'-'; }
					//echo $sc;
			...
			<tr>
                ...
                <td align="center" class="adjacent" style="text-align:center;font-weight:bolder"><?=$sc/2;?></td>
				<td class="adjacent" style="text-align:center;font-weight:bolder"><?php
					//count total question answered	
					echo $totalanswered/2;
				?></td>
				...
				<?php
					...
					if($kirausersno!='0'){
						$updategrade=mysql_query("
							UPDATE mdl_cifaexam_grade SET totalanswer='".$sc."', totalcorrectanswer='".$totalanswered."', 
