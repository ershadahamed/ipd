<?php
	...
	function definition() {
		...
		$mform->addElement('editor','estatementsummary_editor', get_string('content'), null, $editoroptions);
        $mform->addHelpButton('estatementsummary_editor', 'content');
		$mform->addRule('estatementsummary_editor', get_string('content').' Required', 'required', null, 'client');
        $mform->setType('estatementsummary_editor', PARAM_RAW);		
