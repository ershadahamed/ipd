...
<?php
	...
	$statement=" mdl_cifauser a Inner Join mdl_cifaquiz_grades b On a.id = b.userid Inner Join mdl_cifaquiz_attempts c On b.userid = c.userid And b.quiz = c.quiz Inner Join mdl_cifaquiz d On c.quiz = d.id";	
	$statement.=" Where ((a.usertype = 'Active candidate') Or (a.usertype = 'Inactive Candidate'))";
