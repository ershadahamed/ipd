...
if (isloggedin()) {
	...
	";            
            ...
            if ($candidateid1 != '' && $selectsearch1 != '') {
                $statement.= " AND (($selectsearch1 LIKE '%" . $candidateid1 . "%'))";
            }
            if ($candidateid2 != '' && $selectsearch2 != '') {
                $statement.= " AND (($selectsearch2 LIKE '%" . $candidateid2 . "%'))";
            }
            if ($candidateid1 != '' && $selectsearch1 != '' && $candidateid2 != '' && $selectsearch2 != '') {
                $statement.= " AND (($selectsearch1 LIKE '%" . $candidateid1 . "%') AND ($selectsearch2 LIKE '%" . $candidateid2 . "%'))";
            }
