...
<?php } ?>
	...
	?>
	<td rowspan="2"><a href="portal/subscribe/paydetails_loggeduser.php?id=<?=$rowCourses['courseid'];?>"><img src="image/shopcartapply.png" width="30" title="Purchase a <?php echo $rowCourses['fullname'];?>"/></a></td> <?php }} ?>
</tr> <?php } ?>
