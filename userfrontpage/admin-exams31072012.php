...
<table id="availablecourse">
  <tr class="yellow">
    ...
    <th class="adjacent" width="20%">Code</th>
    <th class="adjacent">Exam Name</th>
    <th class="adjacent" width="20%">Exam Centre</th>
...
?>
  <tr valign="middle">
    ...
    <td class="adjacent" style="text-align:left;"><?php echo ucwords(strtolower($sqlrow['shortname'])); ?></td>
