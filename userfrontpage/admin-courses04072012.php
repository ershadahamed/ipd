...
<table id="avalaiblecourse" border="1" style="border-collapse: collapse; background-color: #fff; width:100%;">
  <tr>   
    <th width="1%">No</th>
    <td width="15%" align="left"><strong>Curriculum Name</strong></td>
    <td width="15%" align="left"><strong>Module Code</strong></td>
    <td width="29%" align="left"><strong>Module Name</strong></td>
    <td width="20%" align="left"><strong>Trainer</strong></td>
