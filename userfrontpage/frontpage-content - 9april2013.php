		...
		<tr>
			...
			<table border="0" id="mynoticeboard" cellpadding="0" cellspacing="0" style="padding:0; margin:0; margin-bottom: 0px;">
				...
				<tr valign="top">
					...
					<table width="100%">
					<tr>
					<td width="15%" align="center" valign="top"><img src="<?php echo $CFG->wwwroot.'/image/users.png?id='.$USER->id;?>" width="<?=$iconwidth;?>" border="0" title="<?=get_string('personaldetails');?>"></td>
					<td width="14%" align="center" valign="top"><img src="<?php echo $CFG->wwwroot.'/image/changepwd.png?id='.$USER->id;?>" width="<?=$iconwidth;?>" border="0" title="<?=get_string('changepassword');?>"></td>
					<td width="14%" align="center" valign="top"><img src="<?php echo $CFG->wwwroot.'/image/modules.png?id='.$USER->id;?>" width="<?=$iconwidth;?>" border="0" title="<?=get_string('mytrainingprogram');?>"></td>
					<td width="14%" align="center" valign="top"><img src="<?php echo $CFG->wwwroot.'/image/full-shopping-cart-icon.png?id='.$USER->id;?>" width="48" border="0" title="<?=get_string('purchaseprogram');?>"></td>
					...
					<td width="14%" align="center" valign="top"><img src="<?php echo $CFG->wwwroot.'/image/people_online.png?id='.$USER->id;?>" width="<?=$iconwidth;?>" border="0" title="<?=get_string('feedback');?>"></td>
					<td width="15%" align="center" valign="top"><img src="<?php echo $CFG->wwwroot.'/image/chat-icon.png?id='.$USER->id;?>" width="<?=$iconwidth;?>" border="0" title="<?=get_string('cifachat');?>"></td>
					</tr>
					<tr>
					...
					<td align="center" valign="top"><?=get_string('feedback');?></td>
					...
					<!--table border="0" style="cellpadding:0px;">
					<tr align="center">
					...
					<td width="14%" align="center" valign="top"><a href="<?php echo $CFG->wwwroot.'/hradmin/traineeregistration.php'; ?>">
					...
					<td align="center" valign="top"><a href="<?php echo $CFG->wwwroot.'/coursesindex.php?id='.$USER->id;?>" title="<?=get_string('mytrainingprogram');?>">
						<?=get_string('mytrainingprogram');?></a></td>
					<td align="center" valign="top"><a href="<?php echo $CFG->wwwroot.'/hradmin/traineeregistration.php'; ?>" title="<?=get_string('candidatemanagement');?>">
						<?=get_string('candidatemanagement');?></a></td>
					</tr>
					</table>					
					...
					<td>
						...
						<ul class="list">
							<li><img src="<?php echo $CFG->wwwroot. '/image/system1.png';?>" width="15">
								<a href="<?php echo $CFG->wwwroot.'/user/profile.php?id='.$USER->id;?>"><?=get_string('personaldetails');?></a></li>
							<li><img src="<?php echo $CFG->wwwroot. '/image/system1.png';?>" width="15">
								<a href="<?php echo $CFG->wwwroot.'/user/edit.php?id='.$USER->id.'&course=1';?>" title="<?=get_string('editmyprofile');?>"><?=get_string('editmyprofile');?></a></li>								
							<li><img src="<?php echo $CFG->wwwroot. '/image/system1.png';?>" width="15">
							...
							<?php } ?>
							<?php if($ssql!='0'){ ?>	
								<li><img src="<?php echo $CFG->wwwroot. '/image/system1.png';?>" title="<?=get_string('communicationpreferences');?>" width="15"> 							
								<a href="<?php echo $CFG->wwwroot.'/userfrontpage/update-compreference.php'; ?>"><?=get_string('communicationpreferences');?></a></li>
							<?php }else{ ?>
								<li><img src="<?php echo $CFG->wwwroot. '/image/system1.png';?>" title="<?=get_string('communicationpreferences');?>" width="15"> 							
								<?=get_string('communicationpreferences');?></li>							
							<?php } ?>
						</ul>
						<?php }?>
			...
			<table border="0" id="my1" cellpadding="0" cellspacing="0">
				...
				<td>
					<ul class="list">
						...
						<li><img src="<?php echo $CFG->wwwroot. '/image/system1.png';?>" width="15">
						<a href="<?php echo $CFG->wwwroot.'/userfrontpage/continuepurchases/continuemypurchases.php'; ?>" title="<?=get_string('continuemypurchases');?>"><?=get_string('continuemypurchases');?></a></li>
