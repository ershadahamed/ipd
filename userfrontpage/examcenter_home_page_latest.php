...
<?php 
	...
	$examrules=$CFG->wwwroot. '/examrules/examrules.php?id='.$USER->id;
?>
<p style="font-size:20px;font-weight:bolder;margin-bottom:1.3em;">Welcome to CIFAOnline</p>
                ...
                <div class="row margin-lg-bottom">
                    <div class="col-md-4">
                        <div class="widget-app" style="padding:0px;">
                            <div class="widget-app-header" style="background-color: #5DCBEB; padding:10px 12px">
                            ...
                            <div class="widget-app-body">
                                <div class="link-list">
                                    <ul class="list">
                                        ...
                                        <li class="item"><a class="link" href="<?=$financiallink;?>"><?=get_string('financialstatement');?></a></li>
                                        <?php if($ssql2!='0'){ ?>
										<li class="item"><a class="link" href="<?php echo $CFG->wwwroot.'/userfrontpage/listofnameenrolment.php'; ?>">
											<?=get_string('enrolmentconfirmation');?></a></li>
										<?php }else{ ?>
                                        <li class="item  item-disabled"><a class="link" href="#"><?=get_string('enrolmentconfirmation');?></a></li>		
										<?php } ?>
                                    </ul>
                                </div><!-- .link-list -->
                            </div><!-- .widget-app-body -->
                            ...
                            <div class="widget-app-body">
                                <div class="link-list">
                                    <ul class="list">
                                        ...
                                        <li class="item"><?=$link_mockexam;?><?=get_string('mockexam');?></a></li>
										<?php /*SHAPE IPD*/ if($cIPD!='0'){ /*if($start <= $current && $current <= $ex){ //if ada new course available ?>
											<li class="item"><a class="link" href="<?php echo $CFG->wwwroot.'/coursesindex.php?id='.$USER->id;?>"><?=get_string('newtrainings');?></a></li>
										<?php }else{ ?>
											<li class="item item-disabled"><a class="link" href="#"><?=get_string('newtrainings');?></a></li>
										<?php }*/ ?>
											<li class="item"><a class="link" href="<?=$CFG->wwwroot. '/userfrontpage/viewuserresult.php?id='.$USER->id;?>"><?=get_string('examresultcifa');?></a></li>
											<li class="item"><a class="link" title="<?=get_string('examrules');?>" href="javascript:void(0);" onclick="popupwindow('<?=$examrules;?>','googlePopup',1042,500);"><?=get_string('examrules');?></a></li>
										<?php }else{ ?>
											<li class="item item-disabled"><a class="link" href="#"><?=get_string('newcurriculum');?></a></li>
											<li class="item item-disabled"><a class="link" href="#"><?=get_string('examstatement');?></a></li>
											<li class="item"><a class="link" href="<?=$CFG->wwwroot. '/userfrontpage/viewuserresult.php?id='.$USER->id;?>"><?=get_string('examresultcifa');?></a></li>
											<li class="item item-disabled"><a class="link" href="#"><?=get_string('examregulation');?></a></li>
											<li class="item item-disabled"><a class="link" href="#"><?=get_string('examguide');?></a></li>
										<?php } ?>			
											<?php $policy=$CFG->wwwroot .'/userpolicy.php';?>
											<li class="item"><a class="link" onclick="window.open('<?=$policy;?>', 'Window2', 'width=820,height=600,resizable = 1,scrollbars=1');" href="#">
											<?=get_string('cifaonlinepolicy');?></a></li>
											<li class="item item-disabled"><a class="link" href="#"><?=get_string('onlineportal');?></a></li>
                                    </ul>
                                </div><!-- .link-list -->
                            </div><!-- .widget-app-body -->
                        </div><!-- .widget-app -->
                        ...
                        <div class="widget-app" style="padding:0px;">
                            ...
                            <div class="widget-app-body">
                                <div class="link-list">
                                    <ul class="list">
                                        <li class="item">
											<!--a class="link" href="<?php //echo $CFG->wwwroot.'/mod/chat/gui_ajax/index.php?id=4'; ?>" target="_blank"><?//=get_string('cifachat');?></a-->
											<?php
												$popupchat=$CFG->wwwroot. "/mod/chat/gui_ajax/index.php?id=4";
											?>
											<a class="link" title="CIFAChat" onclick="window.open('<?php echo $popupchat;?>', 'Window2', 'width=800,height=400, scrollbars=1');" href="#">
											<?=get_string('cifachat');?></a>
										</li>
                                        <li class="item item-disabled"><a class="link" href="#"><?=get_string('cifablog');?></a></li>
                                        <li class="item item-disabled"><a class="link" href="#"><?=get_string('ifforums');?></a></li>
                                        <li class="item item-disabled"><a class="link" href="#"><?=get_string('youtube');?></a></li>
                                        <li class="item item-disabled"><a class="link" href="#"><?=get_string('socialnetwork');?></a></li>
										<li class="item">
										<a class="link" href="<?php echo $CFG->wwwroot.'/mod/feedback/complete.php?id=128&courseid=&gopage=0';?>">
										<?=get_string('feedbackreview');?>
										</a></li>
                                    </ul>
                                </div><!-- .link-list -->
                            </div><!-- .widget-app-body -->
