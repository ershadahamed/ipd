            ...
            <div class="col-md-9"> 
                ...
                <div class="row margin-lg-bottom">
                            ...
                            <div class="widget-app-body">
                                <div class="link-list">
                                    <ul class="list">
										...
										<li class="item"><a class="link" href="<?php echo $CFG->wwwroot.'/bulkusersupload.php'; ?>">
										<?=ucwords(strtolower(get_string('uploadusers','admin')));?></a></li>
                                    </ul>
                                </div><!-- .link-list -->
                            </div><!-- .widget-app-body -->
                        </div><!-- .widget-app -->
                    ...
                    <div class="col-md-4" style="padding-top:1em; width:50%">
                        <div class="widget-app">
                            <div class="widget-app-header">
                                <div class="title"><?=get_string('myreport');?></div>
                            </div><!-- .widget-app-header -->
                            <div class="widget-app-body">
                                <div class="link-list">
                                    <ul class="list">
                                        <li class="item item-disabled"><a class="link" href="#"><?=get_string('newreport');?></a></li>
