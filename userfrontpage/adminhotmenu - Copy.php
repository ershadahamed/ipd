...
<table border="0" id="tablecontent" cellpadding="0" cellspacing="0">
  <tr valign="top">
        ...
        <div id="boardblock-div"><div id="board-div-title" class="titlebox"><?=get_string('administrationsite');?></div>
        <table border="0" id="my1" cellpadding="0" cellspacing="0" style="width:100%;">
           ...
           <!--li><img src="<?php //echo $CFG->wwwroot. '/image/system.png';?>" width="15"> <?//=get_string('updatecandidateinfo');?></li-->    	
                </ul>				
            </td>
            </tr>
        </table>
