...
<?php 
	...
	$onlineexamschedule=$CFG->wwwroot;
?>
<p style="font-size:20px;font-weight:bolder;margin-bottom:1.3em;"><?=get_string('returningtosite');?></p>
                ...
                <div class="row margin-lg-bottom">
                    <div class="col-md-4">
                        <div class="widget-app" style="padding:0px;">
                            <div class="widget-app-header" style="padding:10px 12px">
                            ...
                            <div class="widget-app-body">
                                <div class="link-list">
                                    <ul class="list">
                                        ...
                                        <!--li class="item"><a class="link" href="<?//=$flinkmenu;?>"><?//=get_string('financialstatement');?></a></li-->
                    ...
                    <div class="col-md-4">
                        <div class="widget-app" style="padding:0px;">
                            <div class="widget-app-header">
                                <div class="title"><?=$link_mytraining.get_string('myexamcenter').$ahref_close;?></div>
                            </div><!-- .widget-app-header -->
                            <div class="widget-app-body">
                                <div class="link-list">
                                    <ul class="list">
										<!--examregistration_home.php-->
                                        <li class="item"><a class="link" href="<?=$CFG->wwwroot.'/offlineexam/multi_token_download.php?id='.$USER->id; ?>"><?=get_string('candidatemanagement');?></a></li>
										<li class="item"><a class="link" href="<?=$CFG->wwwroot.'/upload_software.php?id='.$USER->id;?>"><?=get_string('uploadexamresult');?></a></li>										
										<li class="item"><a class="link" href="<?=$CFG->wwwroot.'/course/view.php?id=12'; ?>"><?=get_string('downloadexamsoftware');?></a></li>
										<li class="item item-disabled"><a title="Online Exam Schedule" class="link" href="<?=$onlineexamschedule;?>"><?=get_string('onlineexamschedule');?></a></li>
                    ...
                    <div class="col-md-4">
                        <div class="widget-app" style="padding:0px;">
                            <div class="widget-app-header">
                                <div class="title"><?=$link_mycommunity.get_string('myadmin').$ahref_close;?></div>
                            </div><!-- .widget-app-header -->
                            <div class="widget-app-body">
                                <div class="link-list">
                                    <ul class="list">
                                        <li class="item"><a class="link" href="<?=$CFG->wwwroot. '/examcenter/myreport.php';?>"><?=get_string('myreport');?></a></li>
										<li class="item"><a class="link" href="<?=$CFG->wwwroot. '/examcenter/myreport.php';?>"><?=get_string('creatednewreport');?></a></li>
                                        <li class="item"><a class="link" href="<?=$CFG->wwwroot. '/examcenter/myreport.php';?>"><?=get_string('scheduledreport');?></a></li>
                                        <!--li class="item"><a class="link" href="<?//=$CFG->wwwroot. '/userfrontpage/resetpassword.php';?>"><?//=get_string('resetpassword');?></a></li>
                                        <li class="item"><a class="link" href="<?//=$CFG->wwwroot. '/userfrontpage/updatecandidate_details.php';?>"><?//=get_string('updatecandidateinfo');?></a></li>                                        
                                        <li class="item item-disabled"><a class="link" href="#"><?//=get_string('scheduledreport');?></a></li>
										<li class="item"><a class="link" href="<?//=$CFG->wwwroot. '/progress_report.php?id='.$USER->id;?>"><?//=get_string('candidateprogress');?></a></li-->
                                    </ul>
                                </div><!-- .link-list -->
                            </div><!-- .widget-app-body -->
                        </div><!-- .widget-app -->
