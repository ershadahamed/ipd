...
a:active {color:#3D91CB;}  /* selected link */
			...
			<table border="0" id="mynoticeboard" cellpadding="0" cellspacing="0">
				...
				<tr valign="top">
					...
					<tr align="center" valign="top">
						...
						<br/>Upload exam result</a></div></td>							
						<td><div style="padding:3px;">
		...
		<table border="0" id="tablecontent" cellpadding="0" cellspacing="0">
		<tr valign="top">
		<?php if($qrole->roleid != '13'){ //active candidates ?>
		<td style="padding-right:5px;">
			<?php if($qrole->roleid!= '10' && $qrole->roleid != '9' && $qrole->roleid != '12' && $qrole->roleid != '13'){  ?>
			<div id="boardblock-div2"><?php }else{ ?>
			<div id="boardblock-div"><?php } ?>
				...
				<tr valign="top">	
					<td>
						...
						<ul class="list">
							...
							<!--li><img src="<?php //echo $CFG->wwwroot. '/image/system.png';?>" width="15"> 
							<a href="<?php //echo $CFG->wwwroot.'/mod/chat/gui_ajax/index.php?id=4'; ?>" target="_blank">CIFAchat</a></li-->	
						</ul>
						<?php }?>
		...
		<!--My studies-->
		<td style="padding-right:5px;">
			<div id="boardblock-div2">
			<table border="0" id="my1" cellpadding="0" cellspacing="0">
				<tr><td class="titlebox">My training</td></tr>
				<tr valign="top">
				<td>
						<ul class="list">
							<li><img src="<?php echo $CFG->wwwroot. '/image/system.png';?>" width="15">
							<a href="<?php echo $CFG->wwwroot.'/coursesindex.php?id='.$USER->id;?>"> My Training Program</a></li>							
							<!--li><img src="<?php //echo $CFG->wwwroot. '/image/system.png';?>" width="15"> Continue my studies</li-->
							<li><img src="<?php echo $CFG->wwwroot. '/image/system.png';?>" width="15"> Online Training Portal navigation</li>
							<li><img src="<?php echo $CFG->wwwroot. '/image/system.png';?>" width="15">
							<a href="<?php echo $CFG->wwwroot.'/purchasemodule.php?id='.$USER->id; ?>"> New Curriculum</a></li>
							<li><img src="<?php echo $CFG->wwwroot. '/image/system.png';?>" width="15"> Exam Statement</li>
							<li><img src="<?php echo $CFG->wwwroot. '/image/system.png';?>" width="15"> Exam Results</li>
							<li><img src="<?php echo $CFG->wwwroot. '/image/system.png';?>" width="15"> Exam Rules & Regulation</li>
							<li><img src="<?php echo $CFG->wwwroot. '/image/system.png';?>" width="15"> Mock Exam & Exam Guide</li>
							<li><img src="<?php echo $CFG->wwwroot. '/image/system.png';?>" width="15"> 
							<a href="<?=$CFG->wwwroot .'/pluginfile.php/132/block_html/content/SHAPE%20Online%20Training%20Program%20User%20policy.pdf';?>" target="_blank">CIFAOnline policy</a></li>
						</ul>				
				</td>
				</tr>
			</table>
			...
			<table border="0" id="my1" cellpadding="0" cellspacing="0">
				...
				<td>
						<ul class="list">
							<li><img src="<?php echo $CFG->wwwroot. '/image/system.png';?>" width="15"> 
								<a href="<?php echo $CFG->wwwroot.'/mod/chat/gui_ajax/index.php?id=4'; ?>" target="_blank">CIFAChat</a></li>
							<li><img src="<?php echo $CFG->wwwroot. '/image/system.png';?>" width="15"> CIFABlog</li>
							<li><img src="<?php echo $CFG->wwwroot. '/image/system.png';?>" width="15"> IF Forums</li>
							<li><img src="<?php echo $CFG->wwwroot. '/image/system.png';?>" width="15"> Youtube</li>
							<li><img src="<?php echo $CFG->wwwroot. '/image/system.png';?>" width="15"> Social Networking</li>
	...
	<table border="0" id="my1" cellpadding="0" cellspacing="0">
		...
		<td>
				<ul class="list">
					...
					<li><img src="<?php echo $CFG->wwwroot. '/image/system.png';?>" width="15"> CIFAExam portal </li>
				</ul>				
		</td>
		</tr>
	</table>
...
<!--My Community-->
<td style="padding-right:5px;">
	<div id="boardblock-div2" style="height:198px;">
	<table border="0" id="my1" cellpadding="0" cellspacing="0">
		<tr><td class="titlebox">My Community </td></tr>
		<tr valign="top">
