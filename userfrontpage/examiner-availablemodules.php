...
<div class="tabContainer" >
  <ul class="digiTabs" id="sidebarTabs">
    <li id="tab1" class="selected"  onclick="tabs(this);" title="List of available exam">Module Test</li>
    <li id="tab2" onclick="tabs(this);" title="List of exam">Module Exam</li>
  </ul>
  <div id="tabContent">
                <br/>
		<?php include('examiner-moduletest.php'); ?>
  </div>
</div>
...
<div id="tab2Content" style="display:none;">
	<?php include('examiner-availableexam.php'); ?>
</div>