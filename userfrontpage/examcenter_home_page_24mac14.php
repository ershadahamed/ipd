        ...
        <div class="row">
            <div class="col-md-9"> 
                ...
                <div class="row margin-lg-bottom">
                            ...
                            <div class="widget-app-body">
                                <div class="link-list">
                                    <ul class="list">
                                        ...
                                        <li class="item  item-disabled"><a class="link" href="#"><?=get_string('financialstatement');?></a></li>
					...
					<div class="col-md-4">
                        <div class="widget-app">
                            <div class="widget-app-header">
                                <div class="title"><?=get_string('myadmin');?></div>
                            </div><!-- .widget-app-header -->
                            <div class="widget-app-body">
                                <div class="link-list">
                                    <ul class="list">
                                        <li class="item item-disabled"><a class="link" href="<?=$CFG->wwwroot. '/examcenter/myreport.php';?>"><?=get_string('myreport');?></a></li>
                    ...
                    <!--div class="col-md-4" style="padding-top:1em; width:50%">
                        <div class="widget-app">
                            <div class="widget-app-header">
                                <div class="title"><?//=get_string('myadminroles');?></div>
                            </div><!-- .widget-app-header -->
                            <!--div class="widget-app-body">
                                <div class="link-list">
                                    <ul class="list">
                                        <li class="item item-disabled"><a class="link" href="#" target="_blank"><?//=get_string('onlineportal');?></a></li>
                                        <li class="item"><a class="link" href="<?//=$CFG->wwwroot.'/userfrontpage/resetpassword.php';?>"><?//=get_string('resetpassword');?></a></li>
                                        <li class="item"><a class="link" href="<?//=$CFG->wwwroot.'/userfrontpage/updatecandidate_details.php';?>"><?//=get_string('updatecandidateinfo');?></a></li>
                                        <li class="item item-disabled"><a class="link" href="#"><?//=get_string('cifaexamportal');?></a></li>
                                    </ul>
                                </div><!-- .link-list -->
                            <!--/div><!-- .widget-app-body -->
                        <!--/div><!-- .widget-app -->
            ...
            <div class="col-md-3">
                <div class="widget-app" style="padding:0px;">
                    <div class="widget-app-header" class="title" style="background-image: url('ui/images/theme-button-white_h.png'); padding:12px">
                        <div>News & Update</div>
                    </div><!-- .widget-app-header -->
