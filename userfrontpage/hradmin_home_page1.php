                        ...
                        <div class="widget-app" style="padding:0px;">
							<div class="widget-app-header">
								...
								<?php
									...
									}else{ echo get_string('mycandidate'); }
								?>
								</div>
                            </div><!-- .widget-app-header -->
                            <div class="widget-app-body" style="padding:0px; 12px 12px">
                                <div class="link-list">
                                    <ul class="list">
										<li class="item"><a class="link" href="<?=$CFG->wwwroot.'/candidatemanagement/cifacandidatemanagement.php?id='.$USER->id; ?>"><?=get_string('candidatemanagement');?></a></li>
										<li class="item"><a class="link" href="<?=$CFG->wwwroot.'/candidatemanagement/cifacandidatemanagement.php?id='.$USER->id;?>"><?=get_string('resetpword');?></a></li>
                                        <li class="item"><a class="link" href="<?=$CFG->wwwroot.'/candidatemanagement/cifacandidatemanagement.php?id='.$USER->id;?>"><?=get_string('updatedetails');?></a></li> 
										<?php if($rs['roleid']!='12'){ //hr admin ?>
										<li class="item"><a class="link" href="<?=$CFG->wwwroot. '/examcenter/myreport.php';?>"><?=get_string('reportmanagement');?></a></li>
                    ...
                    <div class="col-md-4">
                        <div class="widget-app" style="padding:0px;">
							<div class="widget-app-header">
								...
								<?php }else{ echo get_string('myreport'); } ?>
								</div>
                            </div><!-- .widget-app-header -->
                            <div class="widget-app-body" style="padding:0px; 12px 12px">
                                <div class="link-list">
                                    <ul class="list">
										<?php if($rs['roleid']!='12'){ //hr admin ?>
											<li class="item"><a class="link" href="<?php echo $CFG->wwwroot.'/mod/chat/gui_ajax/index.php?id=4'; ?>" target="_blank"><?=get_string('cifachat');?></a></li>
											...
											<li class="item item-disabled"><a class="link" href="#"><?=get_string('feedbackreview');?></a></li>
										<?php }else{ ?>
											<li class="item"><a class="link" href="<?=$CFG->wwwroot. '/examcenter/myreport.php';?>"><?=get_string('reportmanagement');?></a></li>
											<li class="item"><a class="link" href="<?=$CFG->wwwroot. '/examcenter/myreport.php?id='.$USER->id;?>"><?=get_string('creatednewreport');?></a></li>
											<li class="item item-disabled"><a class="link" href="<?=$CFG->wwwroot. '/examcenter/myreport.php?id='.$USER->id;?>"><?=get_string('scheduledreport');?></a></li>
										<?php } ?>
                                    </ul>
                                </div><!-- .link-list -->
                            </div><!-- .widget-app-body -->
