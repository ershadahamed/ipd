...
<td style="width:75%;">
  ...
  <?php	
	...
	<tr style="font-size:18px;background-color: #5DCBEB;color:#fff;">
		<?php if($rowC != '0'){ // ada logo purchase ?>
			<td style="padding-left:6em;"><b><?=$rowCourses['fullname'];?></b></td>
			<td style="width:20%;text-align:right;"><b><i>$ <?=$rowCourses['cost'];?></li></b></td>
		<?php }else{ ?>
			<td><b><?=$rowCourses['fullname'];?></b></td>
			<td style="width:20%;text-align:right;"><b><i>$ <?=$rowCourses['cost'];?></li></b></td>		
		<?php }?>
	</tr>
	<tr>
	...
	<table style="width:100%; background-color:#fff; border:1.8px solid #3D91CB;" >
		...
		<table id="availablecourse3" width="100%">			
			...
			for($i=0;$i<$max;$i++){
				...
				if($q==0) continue;?>
				<tr><td><?=$q;?></td><td> X </td><td><?=$pname;?></td>
