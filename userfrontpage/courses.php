...
<div class="tabContainer" >
  <ul class="digiTabs" id="sidebarTabs">
		<li id="tab1" class="selected" onclick="tabs(this);" title="List of available courses">List of my courses</li>
		<!--li id="tab2" onclick="tabs(this);" title="List of available exam">List of available Exam</li-->	
  </ul>
  
  <div id="tabContent">
		<?php include('userfrontpage/content1.php'); ?>
  </div>  
</div>
...
<fieldset><legend>List of my courses</legend>
<?php include('userfrontpage/content1.php'); ?>
</fieldset>