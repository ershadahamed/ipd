                            ...
                            <div class="widget-app-body" style="padding:0px; 12px 12px">
                                <div class="link-list">
                                    <ul class="list">
										...
										<li class="item item-disabled"><a class="link" href="<?=$CFG->wwwroot. '/examcenter/myreport.php';?>"><?=get_string('creatednewreport');?></a></li>
                                        <li class="item item-disabled"><a class="link" href="<?=$CFG->wwwroot. '/examcenter/myreport.php';?>"><?=get_string('scheduledreport');?></a></li>
