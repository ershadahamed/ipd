...
a:link {color:#0036ff; text-decoration: none; font-size:11.3px;
		...
		<tr>
			...
			<table border="0" id="mynoticeboard" cellpadding="0" cellspacing="0" style="padding:0; margin:0; margin-bottom: 0px;">
				...
				<tr valign="top">
					...
					<td width="14%" align="center" valign="top"><img src="<?php echo $CFG->wwwroot.'/image/full-shopping-cart-icon.png?id='.$USER->id;?>" width="<?=$iconwidth;?>" border="0" title="<?=get_string('purchaseprogram');?>"></td>
			...
			<table border="0" id="my1" cellpadding="0" cellspacing="0">
				...
				<td>
					<ul class="list">
						...
						<li><img src="<?php echo $CFG->wwwroot. '/image/system1.png';?>" width="15">&nbsp;Continue My Purchase </li>
	...
	<table border="0" id="my1" cellpadding="0" cellspacing="0">
		...
		<td>
				<ul class="list">
					...
					<li><img src="<?php echo $CFG->wwwroot. '/image/system1.png';?>" width="15"> Exam / test results </li>
				</ul>				
		</td>
		</tr>
	</table>
